...
export const jklNormaalikouluTableHead = "Hakeutumisvelvollisia oppijoita (36)"
export const jklNormaalikouluTableContent = `
  ...
  Oppivelvollisuus-keskeytetty-ei-opiskele Valpas         | 1.10.2005   | 9C | 30.5.2021  | Ei hakemusta         | –                           | –                         | –                                                                          |
