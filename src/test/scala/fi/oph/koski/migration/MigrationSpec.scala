  ...
  "Raportointikannan skeema" - {
    "Havaittiin mahdollinen muutos raportointikannan skeemassa. Skeemamuutokset saattavat rikkoa inkrementaalisen kantageneroinnin.\n" +
      ...
      val expectedChecksums = Map(
        ...
        "OppivelvollisuudenVapautusLoader.scala"                    -> "660035268f03b239e8cb3fbc497eb854",
        ...
        "RaportointiDatabase.scala"                                 -> "a476caf729994f6ffd959057040d0047",
        ...
        "RaportointikantaService.scala"                             -> "198d8c3fd7a84bf948b9b04ba453990b",
