  ...
  "Raportointikannan skeema" - {
    ...
    "Havaittiin mahdollinen muutos raportointikannan skeemassa. Skeemamuutokset saattavat rikkoa inkrementaalisen kantageneroinnin.\n" +
      ...
      val expectedChecksums = Map(
        ...
        "RaportointiDatabase.scala"                                 -> "d49ad6d96f6d5e2e9b9b65b6cda85a9c",
        "RaportointiDatabaseCustomFunctions.scala"                  -> "956f101d1219c49ac9134b72a30caf3a",
        "RaportointiDatabaseSchema.scala"                           -> "99f4f2867be02da2085c087351527566",
        "RaportointikantaService.scala"                             -> "88aac5d08709424d4dad4af172d194ac",
        ...
        "OpiskeluoikeusLoaderRowBuilder.scala"                      -> "6f4b9c7f10e7e4fc489e6318b671c57d",
