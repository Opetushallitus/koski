  ...
  "Raportointikannan skeema" - {
    ...
    "Havaittiin mahdollinen muutos raportointikannan skeemassa. Skeemamuutokset saattavat rikkoa inkrementaalisen kantageneroinnin.\n" +
      ...
      val expectedChecksums = Map(
        ...
        "RaportointiDatabase.scala"                                 -> "7342ac77fc2a839b9a07c7089ccaf556",
        ...
        "IncrementalUpdateOpiskeluoikeusLoader.scala"               -> "eb84b64560ba903d3dc9cf419862bcb3",
        "FullReloadOpiskeluoikeusLoader.scala"                      -> "9263a88c0cbea3f68b3580951a445b2f",
