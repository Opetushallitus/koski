  ...
  "Raportointikannan skeema" - {
    ...
    "Havaittiin mahdollinen muutos raportointikannan skeemassa. Skeemamuutokset saattavat rikkoa inkrementaalisen kantageneroinnin.\n" +
      ...
      val expectedChecksums = Map(
        "AikajaksoRowBuilder.scala"                                 -> "be453ed61663b2dcd4b03f8bd4d119c7",
        ...
        "RaportointiDatabase.scala"                                 -> "d13239ea6e7cbdc70bd58b0ed115ceac",
        "RaportointiDatabaseCustomFunctions.scala"                  -> "956f101d1219c49ac9134b72a30caf3a",
        "RaportointiDatabaseSchema.scala"                           -> "d47759f33b419df01b563ae3e911be0c",
        ...
        "IncrementalUpdateOpiskeluoikeusLoader.scala"               -> "40af4a9c8271670574f668e912e49885",
        "FullReloadOpiskeluoikeusLoader.scala"                      -> "c19949cb930233c666ab60353568da98",
