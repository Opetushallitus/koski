  ...
  "Raportointikannan skeema" - {
    "Havaittiin mahdollinen muutos raportointikannan skeemassa. Skeemamuutokset saattavat rikkoa inkrementaalisen kantageneroinnin.\n" +
      ...
      val expectedChecksums = Map(
        ...
        "OpiskeluoikeusLoader.scala"                                -> "3261662972ceec02891baa264decab68",
        ...
        "RaportointiDatabase.scala"                                 -> "6031dc4a8fb6a88ef255c10a0ed926c6",
        ...
        "RaportointikantaService.scala"                             -> "b31c616fe9563a3a78d3b7cf7384b48c",
