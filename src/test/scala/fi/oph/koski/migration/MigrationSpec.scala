  ...
  "Raportointikannan skeema" - {
    "Havaittiin mahdollinen muutos raportointikannan skeemassa. Skeemamuutokset saattavat rikkoa inkrementaalisen kantageneroinnin.\n" +
      ...
      val expectedChecksums = Map(
        "AikajaksoRowBuilder.scala"                                 -> "4f6e0347174cebb42d8b41473a2a89b9",
        ...
        "OpiskeluoikeusLoader.scala"                                -> "c9a1234166e1e942afa0ec93a9d672cf",
        ...
        "RaportointiDatabase.scala"                                 -> "947b8a7ee6c36799f62aecc74346f7a1",
        "RaportointiDatabaseCustomFunctions.scala"                  -> "956f101d1219c49ac9134b72a30caf3a",
        "RaportointiDatabaseSchema.scala"                           -> "c4a3d5d595d9d48e0c42b8d0a9caa5f3",
        "RaportointikantaService.scala"                             -> "a7b08223b366b7f4147e97ad66c0266f",
