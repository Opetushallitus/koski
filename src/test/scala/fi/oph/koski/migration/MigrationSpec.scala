...
class MigrationSpec extends AnyFreeSpec with Matchers with RaportointikantaTestMethods {
  "Migraatiot" - {
    "Havaittiin uusi tietokannan migraatiotiedosto. Migraatiot, varsinkin jos koskevat Kosken suurimpia tauluja, on hyvä testata tietokantareplikaa vasten.\n" +
      ...
      new File("./src/main/resources/db/migration").listFiles.length should equal (111)
    }
  }
  ...
  "Raportointikannan skeema" - {
    ...
    "Havaittiin mahdollinen muutos raportointikannan skeemassa. Skeemamuutokset saattavat rikkoa inkrementaalisen kantageneroinnin.\n" +
      ...
      val expectedChecksums = Map(
        "AikajaksoRowBuilder.scala"                                 -> "eaf46dedebd6641d8e188502263186cc",
        "HenkiloLoader.scala"                                       -> "349c0d837419c58ce7053d2bc505e91",
        ...
        "MuuAmmatillinenRaporttiRowBuilder.scala"                   -> "c31a3262cbef475526b3c348c528df3d",
        ...
        "RaportointiDatabase.scala"                                 -> "324067755de71a0accff7f33414d2e50",
        "RaportointiDatabaseCustomFunctions.scala"                  -> "956f101d1219c49ac9134b72a30caf3a",
        "RaportointiDatabaseSchema.scala"                           -> "50857d172f2b9a24811f38115fd41941",
        ...
        "TOPKSAmmatillinenRaporttiRowBuilder.scala"                 -> "169cc88066eec40df12027f5a0c9e5d4",
        "OpiskeluoikeusLoaderRowBuilder.scala"                      -> "6e21f6fab5aea672fa33600e252c6b16",
        "IncrementalUpdateOpiskeluoikeusLoader.scala"               -> "d81fac7f8a0f770f24dcbb7c85360ad8",
