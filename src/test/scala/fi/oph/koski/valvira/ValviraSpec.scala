  ...
  "ValviraSpec" - {
    ...
    "Tuottaa oikean auditlogin" in {
      ...
      getHetu(KoskiSpecificMockOppijat.valviraaKiinnostavaTutkinto.hetu.get) {
        ...
        AuditLogTester.verifyLastAuditLogMessageForOperation(Map("operation" -> "OPISKELUOIKEUS_KATSOMINEN", "target" -> Map("oppijaHenkiloOid" -> KoskiSpecificMockOppijat.valviraaKiinnostavaTutkinto.oid)))
      }
    }
