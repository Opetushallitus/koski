  ...
  "Suoritustietojen tarkistusraportti" - {
    ...
    "Laskenta" - {
      ...
      "Korotetut suoritukset" in {
        ...
        rivit(1).suoritettujenOpintojenYhteislaajuus should equal("65.0 (54.0)")
        ...
        rivit(1).suoritetutAmmatillisetTutkinnonOsatYhteislaajuus should equal("50.0 (50.0)")
        rivit(1).tunnustetutAmmatillisetTutkinnonOsatYhteislaajuus should equal("20.0 (20.0)")
        rivit(1).pakollisetAmmatillisetTutkinnonOsatYhteislaajuus should equal("20.0 (20.0)")
        rivit(1).valinnaisetAmmatillisetTutkinnonOsatYhteislaajuus should equal("30.0 (30.0)")
        rivit(1).valmiitYhteistenTutkinnonOsatLkm should equal("1")
        rivit(1).pakollisetYhteistenTutkinnonOsienOsaalueidenLkm should equal("3 (3)")
        rivit(1).valinnaistenYhteistenTutkinnonOsienOsaalueidenLKm should equal("1 (1)")
        rivit(1).tunnustettujaTukinnonOsanOsaalueitaValmiissaTutkinnonOsanOsalueissaLkm should equal("3 (3)")
        rivit(1).rahoituksenPiirissäTutkinnonOsanOsaalueitaValmiissaTutkinnonOsanOsaalueissaLkm should equal("3 (3)")
        ...
        rivit(1).suoritettujenYhteistenTutkinnonOsienOsaalueidenYhteislaajuus should equal("11.0 (11.0)")
        rivit(1).tunnustettujaYhteistenTutkinnonOsienValmiistaOsistaYhteislaajuus should equal("11.0")
        rivit(1).suoritettujenYhteistenTutkinnonOsienOsaalueidenYhteislaajuus should equal("11.0 (11.0)")
        rivit(1).pakollistenYhteistenTutkinnonOsienOsaalueidenYhteislaajuus should equal("8.0 (8.0)")
        rivit(1).valinnaistenYhteistenTutkinnonOsienOsaalueidenYhteisLaajuus should equal("3.0 (3.0)")
