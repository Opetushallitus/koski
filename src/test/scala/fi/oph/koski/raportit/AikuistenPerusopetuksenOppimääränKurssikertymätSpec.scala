...
class AikuistenPerusopetuksenOppimääränKurssikertymätSpec
  ...
  "Aikuisten perusopetuksen oppimääräopiskelijoiden kurssikertymien raportti" - {
    ...
    "Raportin kolumnit" in {
      ...
      r.yhteensäSuorituksia should equal(39)
      r.yhteensäSuoritettujenArviointeja should equal(44)
      r.yhteensäSuoritettujaSuorituksia should equal(33)
      r.yhteensäTunnistettujaSuorituksia should equal(6)
      r.yhteensäTunnistettujaSuorituksiaRahoituksenPiirissä should equal(3)
      r.päättövaiheenSuorituksia should equal(10)
      r.päättövaiheenSuoritettujaSuorituksia should equal(6)
      ...
      r.alkuvaiheenSuorituksia should equal(29)
      r.alkuvaiheenSuoritettujaSuorituksia should equal(27)
      ...
      r.suoritetutTaiRahoituksenPiirissäTunnustetutMuutaKauttaRahoitetut should equal(4)
