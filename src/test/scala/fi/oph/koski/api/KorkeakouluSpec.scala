...
class KorkeakouluSpec extends FunSpec with Matchers with OpiskeluoikeusTestMethodsKorkeakoulu with OpintosuoritusoteTestMethods with SearchTestMethods {
