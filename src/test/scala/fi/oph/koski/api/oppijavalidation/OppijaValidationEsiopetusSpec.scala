...
class OppijaValidationEsiopetusSpec extends TutkinnonPerusteetTest[EsiopetuksenOpiskeluoikeus] with EsiopetusSpecification {
  ...
  "Pidennetyn oppivelvollisuuden aikajakso" - {
    ...
    "Validointi ei onnistu, kun opiskeluoikeus sisältää pidennetyn oppivelvollisuuden mutta ei vammaisuusjaksoja" in {
      ...
      validate(oo).swap.toOption.get should equal (HttpStatus.fold(
        ...
        KoskiErrorCategory.badRequest.validation.date.pidennettyOppivelvollisuus(
          "Pidennetyn oppivelvollisuuden (1.4.2016-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
        ),
        KoskiErrorCategory.badRequest.validation.date(
          "Erityisen tuen päätöksen (1.4.2016-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
        ),
      ))
    }
    ...
    "Validointi onnistuu, kun opiskeluoikeus sisältää vaikeasti vammaisuuden mutta ei vammaisuuden jakson ja jaksojen loppua ei ole määritelty eikä opiskeluoikeus ole valmis" in {
      val tuenLoppu = LocalDate.of(2017, 4, 1)
      val oo = defaultOpiskeluoikeus.copy(
        lisätiedot = Some(
          ExamplesEsiopetus.lisätiedot.copy(
            pidennettyOppivelvollisuus = Some(Aikajakso(alku, Some(tuenLoppu))),
            erityisenTuenPäätökset = Some(List(
              ErityisenTuenPäätös(
                alku = Some(alku),
                loppu = Some(tuenLoppu),
                opiskeleeToimintaAlueittain = true,
                erityisryhmässä = Some(true)
              ),
            )),
            vammainen = None,
            vaikeastiVammainen = Some(List(Aikajakso(alku, Some(tuenLoppu)))),
          )
        ),
        tila = esiopetusTilaLäsnä
      )

      validate(oo) should matchPattern { case Right(_) => }
    }
    ...
    "Validointi ei onnistu, kun opiskeluoikeus sisältää pidennetyn oppivelvollisuuden jakson joka alkaa vammaisuusjaksojen jälkeen" in {
      ...
      validate(oo).swap.toOption.get should equal (HttpStatus.fold(
        ...
        KoskiErrorCategory.badRequest.validation.date.pidennettyOppivelvollisuus(
          "Pidennetyn oppivelvollisuuden (3.4.2016-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
        ),
        KoskiErrorCategory.badRequest.validation.date.vammaisuusjakso(
          "Vammaisuuden jakson (1.4.2016-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
        ),
        KoskiErrorCategory.badRequest.validation.date(
          "Erityisen tuen päätöksen (1.4.2016-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
        ),
    ...
    "Validointi ei onnistu, kun opiskeluoikeus sisältää vammaisuusjakson, joka on kokonaan pidennetyn oppivelvollisuuden ulkopuolella" in {
      ...
      validate(oo).swap.toOption.get should equal (HttpStatus.fold(
        ...
        KoskiErrorCategory.badRequest.validation.date.pidennettyOppivelvollisuus(
          "Pidennetyn oppivelvollisuuden (5.4.2016-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
        ),
        KoskiErrorCategory.badRequest.validation.date.vammaisuusjakso(
          "Vammaisuuden jakson (5.4.2016-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
        ),
        KoskiErrorCategory.badRequest.validation.date(
          "Erityisen tuen päätöksen (1.4.2016-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
        ),
    ...
    "Validointi ei onnistu, kun opiskeluoikeus sisältää pidennetyn oppivelvollisuuden jakson joka alkaa ennen vammaisuusjaksoa" in {
      ...
      validate(oo).swap.toOption.get should equal (HttpStatus.fold(
        ...
        KoskiErrorCategory.badRequest.validation.date.pidennettyOppivelvollisuus(
          "Pidennetyn oppivelvollisuuden (31.3.2016-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
        ),
        KoskiErrorCategory.badRequest.validation.date.vammaisuusjakso(
          "Vaikeasti vammaisuuden jakson (1.4.2016-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
        ),
        KoskiErrorCategory.badRequest.validation.date(
          "Erityisen tuen päätöksen (31.3.2016-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
        ),
      ))
    }
  ...
  "Opiskeluoikeudet oppivelvollisuuden pidennyksen ja tuen päätöksien muutosten siirtymäajan (1.8.2025 - 31.8.2026) yli" - {
    ...
    ) = ExamplesEsiopetus.opiskeluoikeus2025.copy(lisätiedot = Some(EsiopetuksenOpiskeluoikeudenLisätiedot(
      tuenPäätöksenJaksot = tuenPäätöksenJaksot,
      erityisenTuenPäätökset = erityisenTuenPäätökset,
      varhennetunOppivelvollisuudenJaksot = varhennetunOppivelvollisuudenJaksot,
        ...
        val oo = makeOpiskeluoikeus(
          ...
          tila = NuortenPerusopetuksenOpiskeluoikeudenTila(
            List(
              ...
              NuortenPerusopetuksenOpiskeluoikeusjakso(date(2026, 9, 1), opiskeluoikeusValmistunut)
            )
          )
        )
        setupOppijaWithOpiskeluoikeus(oo) {
          verifyResponseStatus(400,
            KoskiErrorCategory.badRequest.validation.date.pidennettyOppivelvollisuus(
              "Pidennetyn oppivelvollisuuden (13.8.2025-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
            ),
            KoskiErrorCategory.badRequest.validation.date.vammaisuusjakso(
              "Vaikeasti vammaisuuden jakson (13.8.2025-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
            ),
            KoskiErrorCategory.badRequest.validation.date(
              "Erityisen tuen päätöksen (13.8.2025-) viimeinen mahdollinen päättymispäivä on 31.8.2026."
            ),
          )
        }
      }
    ...
    "Pidennettyä oppivelvollisuutta ei voi merkitä sallittujen päivien ulkopuolelle opiskeluoikeudelle, joka alkaa rajapäivän (31.8.2026) jälkeen" - {
      "Suljettu aikajakso" in {
        ...
        setupOppijaWithOpiskeluoikeus(oo) {
          verifyResponseStatus(400,
            KoskiErrorCategory.badRequest.validation.date.pidennettyOppivelvollisuus("Pidennetyn oppivelvollisuuden (1.9.2026-30.6.2027) viimeinen mahdollinen alkamispäivä on 31.7.2026."),
            KoskiErrorCategory.badRequest.validation.date.pidennettyOppivelvollisuus("Pidennetyn oppivelvollisuuden (1.9.2026-30.6.2027) viimeinen mahdollinen päättymispäivä on 31.8.2026."),
            KoskiErrorCategory.badRequest.validation.date.vammaisuusjakso("Vammaisuuden jakson (1.9.2026-30.6.2027) viimeinen mahdollinen alkamispäivä on 31.7.2026."),
            KoskiErrorCategory.badRequest.validation.date.vammaisuusjakso("Vammaisuuden jakson (1.9.2026-30.6.2027) viimeinen mahdollinen päättymispäivä on 31.8.2026."),
            KoskiErrorCategory.badRequest.validation.date("Erityisen tuen päätöksen (1.9.2026-30.6.2027) viimeinen mahdollinen alkamispäivä on 31.7.2026."),
            KoskiErrorCategory.badRequest.validation.date("Erityisen tuen päätöksen (1.9.2026-30.6.2027) viimeinen mahdollinen päättymispäivä on 31.8.2026."),
          )
        }
      }
      ...
      "Avoin aikajakso" in {
        ...
        setupOppijaWithOpiskeluoikeus(oo) {
          verifyResponseStatus(400,
            KoskiErrorCategory.badRequest.validation.date.pidennettyOppivelvollisuus("Pidennetyn oppivelvollisuuden (1.9.2026-) viimeinen mahdollinen alkamispäivä on 31.7.2026."),
            KoskiErrorCategory.badRequest.validation.date.pidennettyOppivelvollisuus("Pidennetyn oppivelvollisuuden (1.9.2026-) viimeinen mahdollinen päättymispäivä on 31.8.2026."),
            KoskiErrorCategory.badRequest.validation.date.vammaisuusjakso("Vaikeasti vammaisuuden jakson (1.9.2026-) viimeinen mahdollinen alkamispäivä on 31.7.2026."),
            KoskiErrorCategory.badRequest.validation.date.vammaisuusjakso("Vaikeasti vammaisuuden jakson (1.9.2026-) viimeinen mahdollinen päättymispäivä on 31.8.2026."),
            KoskiErrorCategory.badRequest.validation.date("Erityisen tuen päätöksen (1.9.2026-) viimeinen mahdollinen alkamispäivä on 31.7.2026."),
    ...
    "Pidennettyä oppivelvollisuutta ei voi merkitä sallittujen päivien ulkopuolelle, vaikka opiskeluoikeus päättyy ennen rajapäivää" - {
      ...
      "Suljettu aikajakso on kielletty, kun jaksot eivät ole sallituissa rajoissa" in {
        val oo = makeOpiskeluoikeus(
          ...
          tila = NuortenPerusopetuksenOpiskeluoikeudenTila(List(
            NuortenPerusopetuksenOpiskeluoikeusjakso(date(2025, 8, 13), opiskeluoikeusLäsnä),
            NuortenPerusopetuksenOpiskeluoikeusjakso(date(2026, 6, 30), opiskeluoikeusValmistunut),
          ))
        )
        setupOppijaWithOpiskeluoikeus(oo) {
          verifyResponseStatus(400,
    ...
    "Pidennettyä oppivelvollisuutta ei voi merkitä alkamaan 1.8.2026 tai sen jälkeen" - {
      "Suljettu aikajakso" in {
        setupOppijaWithOpiskeluoikeus(makeOpiskeluoikeus(
          pidennettyOppivelvollisuus = Some(Aikajakso(
          ...
          verifyResponseStatus(400,
            KoskiErrorCategory.badRequest.validation.date.pidennettyOppivelvollisuus(
              "Pidennetyn oppivelvollisuuden (1.8.2026-31.8.2026) viimeinen mahdollinen alkamispäivä on 31.7.2026."
            ),
            KoskiErrorCategory.badRequest.validation.date.vammaisuusjakso(
              "Vammaisuuden jakson (1.8.2026-31.8.2026) viimeinen mahdollinen alkamispäivä on 31.7.2026."
            ),
            KoskiErrorCategory.badRequest.validation.date(
              "Erityisen tuen päätöksen (1.8.2026-31.8.2026) viimeinen mahdollinen alkamispäivä on 31.7.2026."
            ),
          )
        }
      }
      ...
      "Avoin aikajakso" in {
        setupOppijaWithOpiskeluoikeus(makeOpiskeluoikeus(
          ...
          verifyResponseStatus(400,
            KoskiErrorCategory.badRequest.validation.date.pidennettyOppivelvollisuus("Pidennetyn oppivelvollisuuden (1.8.2026-) viimeinen mahdollinen alkamispäivä on 31.7.2026."),
            KoskiErrorCategory.badRequest.validation.date.vammaisuusjakso("Vaikeasti vammaisuuden jakson (1.8.2026-) viimeinen mahdollinen alkamispäivä on 31.7.2026."),
            KoskiErrorCategory.badRequest.validation.date("Erityisen tuen päätöksen (1.8.2026-) viimeinen mahdollinen alkamispäivä on 31.7.2026."),
          )
        }
      }
    }

    "Pidennetty oppivelvollisuus sallittu, kun jakso alkaa ennen 1.8.2026" in {
      setupOppijaWithOpiskeluoikeus(makeOpiskeluoikeus(
        pidennettyOppivelvollisuus = Some(Aikajakso(
          alku = Some(date(2026, 7, 31)),
          loppu = Some(date(2026, 8, 31)),
        )),
        vammainen = Some(List(Aikajakso(
          alku = Some(date(2026, 7, 31)),
