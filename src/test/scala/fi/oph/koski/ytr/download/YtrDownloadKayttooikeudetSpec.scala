    ...
    with YtrDownloadTestMethods
{
  ...
  private lazy val ytrOppijat = MockYtrClient.oppijatByHetut(YtrSsnDataWithPreviousSsns(ssns = Some(List("080380-2432", "140380-336X", "220680-7850", "240680-087S", "060807A7787", "300805A756F").map(ssn => YtrSsnWithPreviousSsns(ssn)))))
