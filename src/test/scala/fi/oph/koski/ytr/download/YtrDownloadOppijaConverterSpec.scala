...
import fi.oph.koski.ytr.{MockYrtClient, YtrConversionUtils, YtrSsnWithPreviousSsns}
...
class YtrDownloadOppijaConverterSpec extends AnyFreeSpec with TestEnvironment with Matchers {
  ...
  "Yksinkertainen YTR:n latausrajapinnan palauttama oppija osataan konvertoida" in {
    val oppijat = MockYrtClient.oppijatByHetut(YtrSsnDataWithPreviousSsns(ssns = Some(List("080380-2432", "140380-336X", "220680-7850", "240680-087S", "060807A7787", "300805A756F").map(ssn => YtrSsnWithPreviousSsns(ssn)))))
