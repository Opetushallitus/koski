  ...
  "YTL rajapinta" - {
    ...
    "Kosken testioppijoiden hakeminen oidilla onnistuu" in {
      val oidit = List(
        ...
        KoskiSpecificMockOppijat.lukioDiaIbInternationalESHOpiskelijamaaratRaportti_nuortenOppimaara,
        KoskiSpecificMockOppijat.lukioDiaIbInternationalESHOpiskelijamaaratRaportti_aikuistenOppimaara,
        KoskiSpecificMockOppijat.lukioDiaIbInternationalESHOpiskelijamaaratRaportti_aineopiskelija,
