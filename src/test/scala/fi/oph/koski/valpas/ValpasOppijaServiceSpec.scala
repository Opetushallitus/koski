...
class ValpasOppijaServiceSpec extends ValpasTestBase with BeforeAndAfterEach {
  ...
  private val oppivelvolliset = List(
    ...
    (
      ...
      List(
        ExpectedData(ValpasOpiskeluoikeusExampleData.lukionOpiskeluoikeusAlkaa2021Lokakuussa(None), "voimassatulevaisuudessa", false, false, false),
        ExpectedData(ValpasOpiskeluoikeusExampleData.valmistunutYsiluokkalainen, "valmistunut", true, true, false)
      )
    ),
    (
    ...
    (
      ...
      List(
        ExpectedData(ValpasOpiskeluoikeusExampleData.lukionOpiskeluoikeusAlkaa2021Syksyllä(None), "voimassa", false, false, false),
        ExpectedData(ValpasOpiskeluoikeusExampleData.valmistunutYsiluokkalainen, "valmistunut", true, true, false)
      )
    ),
    (
