...
object ValpasKuntarouhintaSpec {
  ...
  def eiOppivelvollisuuttaSuorittavatOppijat(t: LocalizationReader) = List(
    ...
    RouhintaExpectedData(
      oppija = ValpasMockOppijat.eshEbTutkinnonAloittanut,
      ooPäättymispäivä = t.get("rouhinta_ei_opiskeluoikeutta"),
      ooViimeisinTila = None,
      ooKoulutusmuoto = None,
      ooToimipiste = None,
    ...
    RouhintaExpectedData(
      oppija = ValpasMockOppijat.eshEbTutkinnostaEronnut,
      ooPäättymispäivä = t.get("rouhinta_ei_opiskeluoikeutta"),
      ooViimeisinTila = None,
      ooKoulutusmuoto = None,
      ooToimipiste = None,
    ...
    RouhintaExpectedData(
      oppija = ValpasMockOppijat.eshEbTutkinnostaValmistunut,
      ooPäättymispäivä = t.get("rouhinta_ei_opiskeluoikeutta"),
      ooViimeisinTila = None,
      ooKoulutusmuoto = None,
      ooToimipiste = None,
    ...
    RouhintaExpectedData(
      oppija = ValpasMockOppijat.eshKeskenEbTutkinnonAloittanut,
      ooPäättymispäivä = t.get("rouhinta_ei_opiskeluoikeutta"),
      ooViimeisinTila = None,
      ooKoulutusmuoto = None,
      ooToimipiste = None,
