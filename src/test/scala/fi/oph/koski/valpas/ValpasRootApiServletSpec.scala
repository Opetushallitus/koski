...
import fi.oph.koski.valpas.oppija.{ValpasEiLainTaiMaksuttomuudenPiirissäHenkilöhakuResult, ValpasEiLöytynytHenkilöhakuResult, ValpasErrorCategory, ValpasHenkilöhakuResult, ValpasLöytyiHenkilöhakuResult}
