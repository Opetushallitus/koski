...
class TorOppijaValidationPerusopetusSpec extends FunSpec with OpiskeluoikeusTestMethodsPeruskoulutus {
  ...
  def putTodistus[A](suoritus: PeruskoulunPäättötodistus, henkilö: Henkilö = defaultHenkilö, headers: Headers = authHeaders() ++ jsonContent)(f: => A): A = {
