...
case class LukionOpiskeluoikeusjakso(
  ...
  @Description("Opintojen rahoitus. Mikäli kyseessä on kaksoitutkintoa suorittava opiskelija, jonka rahoituksen saa ammatillinen oppilaitos, tulee käyttää arvoa 6: Muuta kautta rahoitettu. Muussa tapauksessa käytetään arvoa 1: Valtionosuusrahoitteinen koulutus. Lukuvuosimaksu 16 käytössä vain 1.8.2026 tai myöhemmin alkavissa lukion opiskeluoikeuksissa.")
  @KoodistoKoodiarvo("1")
  @KoodistoKoodiarvo("6")
