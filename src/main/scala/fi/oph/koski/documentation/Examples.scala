...
object Examples {
  val oppijaExamples: List[Example] =
    ExamplesAmmatillinen.examples ++
    ExamplesMuuAmmatillinen.examples ++
    ExamplesValma.examples ++
    ExamplesTelma.examples ++
    ...
    ExamplesLukio2019.examples ++
    ExamplesYlioppilastutkinto.examples ++
    ExamplesKorkeakoulu.examples ++
    ExamplesTiedonsiirto.examples ++
    ExamplesIB.examples ++
    ExamplesDIA.examples ++
    ExamplesInternationalSchool.examples ++
    ...
    ExamplesKielitutkinto.examples
