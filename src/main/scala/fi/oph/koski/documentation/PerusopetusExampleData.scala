...
object PerusopetusExampleData {
  ...
  def aikuistenArviointi(arvosana: Int): Some[List[AikuistenPerusopetuksenOppiaineenArviointi]] = Some(List(AikuistenPerusopetuksenOppiaineenArviointi(arvosana)))
