...
object PerusopetusExampleData {
  ...
  def äidinkieli(kieli: String, diaarinumero: Option[String] = None) = PeruskoulunAidinkieliJaKirjallisuus(kieli = Koodistokoodiviite(koodiarvo = kieli, koodistoUri = "oppiaineaidinkielijakirjallisuus"))
