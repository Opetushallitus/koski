...
class DocumentationServlet(implicit val application: KoskiApplication)
  ...
  get("^/(|tietomalli|koodistot|rajapinnat/opintohallintojarjestelmat|rajapinnat/luovutuspalvelu|rajapinnat/palveluvayla-omadata|rajapinnat/massaluovutus/koulutuksenjarjestajat|rajapinnat/massaluovutus/oph)$".r)(nonce => {
