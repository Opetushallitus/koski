...
import fi.oph.koski.ytr.{MockYtrClient, YtrOppijaConverter, YtrSsnWithPreviousSsns}
...
object ExamplesYlioppilastutkinto {
  ...
  val opiskeluoikeus = MockYtrClient.oppijaByHetu(YtrSsnWithPreviousSsns(KoskiSpecificMockOppijat.ylioppilas.hetu.get))
