...
//    secondaryUpperSuoritusS7(luokkaaste, alkamispäivä, jääLuokalle).copy(
//      osasuoritukset = Some(List(
//        secondaryUpperMuunOppiaineenOsasuoritusS7(
//          oppiainekoodi = "PE",
...
//  def secondaryUpperMuunOppiaineenOsasuoritus(luokkaAste: String)(
//    oppiainekoodi: String,
//    laajuus: Int = 2,
//    suorituskieli: Koodistokoodiviite = ExampleData.englanti,
...
//  ) = {
//    luokkaAste match {
//      case "S6" => secondaryUpperMuunOppiaineenOsasuoritusS6(oppiainekoodi, laajuus, suorituskieli, arviointi)
//      case "S7" => secondaryUpperMuunOppiaineenOsasuoritusS7(oppiainekoodi, laajuus, suorituskieli, arviointi)
//    }
//  }
//
//  def secondaryUpperKieliOppiaineenOsasuoritus(luokkaAste: String)(
//    oppiainekoodi: String,
//    laajuus: Int = 2,
//    kieli: Koodistokoodiviite = ExampleData.englanti,
//    suorituskieli: Koodistokoodiviite = ExampleData.englanti,
...
//  ) = {
//    luokkaAste match {
//      case "S6" => secondaryUpperKieliOppiaineenOsasuoritusS6(oppiainekoodi, laajuus, kieli, suorituskieli, arviointi)
//      case "S7" => secondaryUpperKieliOppiaineenOsasuoritusS7(oppiainekoodi, laajuus, kieli, suorituskieli, arviointi)
//    }
//  }
