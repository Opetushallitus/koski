...
object EuropeanSchoolOfHelsinkiExampleData {
  lazy val europeanSchoolOfHelsinki: Oppilaitos = Oppilaitos(MockOrganisaatiot.EuropeanSchoolOfHelsinki.oppilaitos, Some(Koodistokoodiviite("03782", None, "oppilaitosnumero", None)), Some("European School of Helsinki"))
  lazy val europeanSchoolOfHelsinkiToimipiste: Toimipiste = Toimipiste(EuropeanSchoolOfHelsinki.toimipiste)
  ...
  def ebTutkintoPreliminaryMarkArviointi(
    ...
    arvioitsijat: Option[List[Arvioitsija]] = Some(List(Arvioitsija("Pekka Paunanen"))),
    päivä: LocalDate
  ): Option[List[DeprecatedEBTutkintoPreliminaryMarkArviointi]] = {
    Some(List(DeprecatedEBTutkintoPreliminaryMarkArviointi(
      arvosana = Koodistokoodiviite(koodiarvo = arvosana, koodistoUri = "arviointiasteikkoeuropeanschoolofhelsinkis7preliminarymark"),
      päivä = Some(päivä),
      arvioitsijat = arvioitsijat
    )))
  ...
  def ebTutkintoFinalMarkArviointi(
    ...
    arvioitsijat: Option[List[Arvioitsija]] = Some(List(Arvioitsija("Pekka Paunanen"))),
    päivä: LocalDate
  ): Option[List[DeprecatedEBTutkintoFinalMarkArviointi]] = {
    Some(List(DeprecatedEBTutkintoFinalMarkArviointi(
