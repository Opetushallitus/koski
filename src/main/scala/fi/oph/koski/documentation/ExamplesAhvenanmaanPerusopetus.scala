...
object AhvenanmaanPerusopetusExampleData {
  ...
  val ysiluokanOppiaineet = List(
    ...
    oppiaineenSuoritus(oppiaine("RO", "Religions- och livsåskådningskunskap"), 8),
    oppiaineenSuoritus(oppiaine("HI", "Historia"), 9),
    oppiaineenSuoritus(oppiaine("YH", "Samhällskunskap"), 8),
    ...
    oppiaineenSuoritus(oppiaine("KO", "Hem- och konsumentkunskap"), 8),
