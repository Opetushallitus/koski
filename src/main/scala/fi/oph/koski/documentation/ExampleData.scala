...
object ExampleData {
  ...
  lazy val ranska = Koodistokoodiviite("FR", Some("ranska"), "kieli", None)
  lazy val saksa = Koodistokoodiviite("DE", Some("saksa"), "kieli", None)
  lazy val viro = Koodistokoodiviite("ET", Some("viro"), "kieli", None)
