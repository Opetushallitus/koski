...
object ExamplesKorkeakoulu {
  lazy val opiskeluoikeudet = MockVirtaOpiskeluoikeusRepository.findByOppija(MockOppijat.dippainssi.henkilö)(KoskiSession.systemUser)
  lazy val oppija = Oppija(asUusiOppija(MockOppijat.dippainssi.henkilö), opiskeluoikeudet)
