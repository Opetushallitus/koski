...
object ExamplesKorkeakoulu {
  lazy val opiskeluoikeudet = MockVirtaOpiskeluoikeusRepository.findByOppija(MockOppijat.dippainssi)(KoskiSession.systemUser)
  lazy val oppija = Oppija(asUusiOppija(MockOppijat.dippainssi), opiskeluoikeudet)
