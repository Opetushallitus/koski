...
object LukioExampleData {
  ...
  def paikallinenKurssi(koodi: String, nimi: String, kuvaus: String) = PaikallinenLukionKurssi(PaikallinenKoodi(koodiarvo = koodi, nimi = nimi, koodistoUri = "paikallinen"), laajuus(1.0f), kuvaus)
