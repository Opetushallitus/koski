...
object ExamplesLukio {
  ...
  lazy val erityisenKoulutustehtävänJakso = ErityisenKoulutustehtävänJakso(date(2012, 9, 1), Some(date(2012, 9, 1)), Koodistokoodiviite("104", Some("Kuvataiteeseen painottuva opetus"), "erityinenkoulutustehtava"))
