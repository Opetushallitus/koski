  ...
  object badRequest extends ErrorCategory("badRequest", 400, "Epäkelpo syöte") {
    ...
    class Validation extends ErrorCategory(badRequest, "validation", "Syötteen validointi epäonnistui") {
      ...
      class Tila extends ErrorCategory(Validation.this, "tila", "Suorituksen tilaan liittyvä validointivirhe") {
        ...
        val valmaTilaEiSallittu = subcategory("valmaOpiskeluoikeudenTilaEiSallittu", "Valmentavan koulutuksen opiskeluoikeudelle ei ole mahdollista merkitä uusia opiskeluoikeuden tiloja, joiden alkupäivämäärä on 3.9.2022 tai sen jälkeen.")
        val perusopetuksenLisäopetuksenTilaEiSallittu = subcategory("perusopetuksenLisäopetuksenOpiskeluoikeudenTilaEiSallittu", "Perusopetuksen lisäopetuksen opiskeluoikeudelle ei ole mahdollista merkitä uusia opiskeluoikeuden tiloja, joiden alkupäivämäärä on 3.9.2022 tai sen jälkeen.")
      }
      val tila = new Tila
