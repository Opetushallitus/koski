  ...
  object badRequest extends ErrorCategory("badRequest", 400, "Epäkelpo syöte") {
    ...
    class Validation extends ErrorCategory(badRequest, "validation", "Syötteen validointi epäonnistui") {
      ...
      class Laajuudet extends ErrorCategory(Validation.this, "laajuudet", "Suoritusten laajuuksiin liittyvä validointivirhe") {
        ...
        val yhteenlaskettuLaajuusVääräLops2015Aikuiset = subcategory("lops2015VääräLaajuus", "Lukion aikuisten oppimäärän LOPS2015 voi merkitä valmiiksi vain kun vähintään 44 kurssia on suoritettu")
        val yhteenlaskettuLaajuusVääräLops2015Nuoret = subcategory("lops2015VääräLaajuus", "Lukion nuorten oppimäärän LOPS2015 voi merkitä valmiiksi vain kun vähintään 75 kurssia on suoritettu")
