  ...
  object badRequest extends ErrorCategory("badRequest", 400, "Epäkelpo syöte") {
    ...
    class Validation extends ErrorCategory(badRequest, "validation", "Syötteen validointi epäonnistui") {
      ...
      class Date extends ErrorCategory(Validation.this, "date", "Päivämäärä on oikeassa formaatissa, mutta semanttisesti epäkelpo.") {
        ...
        val vammaisuusjaksoPidennetynOppivelvollisuudenUlkopuolella = subcategory("vammaisuusjaksoPidennetynOppivelvollisuudenUlkopuolella", "Vammaisuustiedon aikajakso on pidennetyn oppivelvollisuuden aikajakson ulkopuolella tai pidennetyn oppivelvollisuuden aikajakso puuttuu.")
      }
      val date = new Date
