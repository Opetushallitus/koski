...
object MockOppijat {
  ...
  val suoritusTuplana = oppijat.oppija("Tupla", "Toivo", "270298-533H")
  ...
  val aikuisOpiskelijaMuuKuinVos = oppijat.oppija("Aikuinen", "AikuisopiskelijaMuuKuinVos", "241001B7650")
  ...
  val eskariAikaisillaLisätiedoilla = oppijat.oppija("Lisä-Eskari", "Essiina", "300996-872E")
  ...
  val organisaatioHistoriallinen = oppijat.oppija("o", "organisaatioHistoriallinen", "210728-156E")
  ...
  val vapaaSivistystyöOppivelvollinen = oppijat.oppija("Vapaa-Sivistys", "Oppivelvollinen", "080177-870W")
