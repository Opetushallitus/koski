...
object MockOppijat {
  ...
  val aikuisOpiskelijaMuuKuinVos = oppijat.oppija("Aikuinen", "AikuisopiskelijaKuuKuinVos", "241001B7650")
  val aikuisAineOpiskelijaMuuKuinVos = oppijat.oppija("Aikuinen", "AikuisAineOpiskelijaKuuKuinVos", "241001B7649")
