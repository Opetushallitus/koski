...
object KoskiSpecificMockOppijat {
  ...
  val lukioDiaIbInternationalESHOpiskelijamaaratRaportti_nuortenOppimaara = koskiSpecificOppijat.oppija("nuorten", "oppimaara", "180900A955N")
  val lukioDiaIbInternationalESHOpiskelijamaaratRaportti_aikuistenOppimaara = koskiSpecificOppijat.oppija("aikuisten", "oppimaara", "180900A991U")
  val lukioDiaIbInternationalESHOpiskelijamaaratRaportti_aineopiskelija = koskiSpecificOppijat.oppija("aine", "opiskelija", "180900A945B")
  ...
  val pelkkäYoKannassaUudenOvLainPiirissä = koskiSpecificOppijat.oppija("Muita-opiskeluoikeuksia", "Valpas", "060807A7787", syntymäaika = Some(LocalDate.of(2007, 8, 6)), kotikunta = Some("091"))
