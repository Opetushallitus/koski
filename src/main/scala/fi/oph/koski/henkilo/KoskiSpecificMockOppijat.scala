...
object KoskiSpecificMockOppijat {
  ...
  val teija = koskiSpecificOppijat.oppija("Tekijä", "Teija", "251019-039B", kotikunta = Some(Kunta.helsinki),
    kuntahistoriaMock = h => {
      val historia = Seq(
  ...
  val oikeusOpiskelunMaksuttomuuteen = koskiSpecificOppijat.oppija("Oikeus", "Maksuttomuuteen", "010104A6094", syntymäaika = Some(LocalDate.of(2004, 12, 31)), kotikunta = Some(Kunta.helsinki))
  val eiOikeuttaMaksuttomuuteen = koskiSpecificOppijat.oppija("EiOikeutta", "Maksuttomuuteen", "311203A1454", syntymäaika = Some(LocalDate.of(2003, 12, 31)), kotikunta = Some(Kunta.helsinki))
  ...
  val oppivelvollisuustietoLiianVanha = koskiSpecificOppijat.oppija("Oppivelvollisuustieto", "LiianVanha", "311203A245B", syntymäaika = Some(LocalDate.of(2003, 12, 31)), kotikunta = Some(Kunta.helsinki))
  val oppivelvollisuustietoMaster = koskiSpecificOppijat.oppija("Oppivelvollisuustieto", "Master", "260904A350B", syntymäaika = Some(LocalDate.of(2004, 1, 1)), kotikunta = Some(Kunta.helsinki))
  val oppivelvollisuustietoSlave1 = koskiSpecificOppijat.addOppijaHenkilöWithMasterInfo(OppijaHenkilöWithMasterInfo(LaajatOppijaHenkilöTiedot(oid = "1.2.246.562.24.00000051491", sukunimi = "Oppivelvollisuustieto", etunimet = "Slave1", kutsumanimi = "Slave1", hetu = Some("260904A350B"), syntymäaika = Some(LocalDate.of(2005, 1, 1)), kotikunta = Some(Kunta.helsinki)), Some(oppivelvollisuustietoMaster)))
  ...
  val maksuttomuuttaPidennetty1 = koskiSpecificOppijat.oppija("Pidennetty1", "Maksuttomuutta1", "190525-0401", syntymäaika = Some(LocalDate.of(2004, 1, 1)), kotikunta = Some(Kunta.helsinki))
  val maksuttomuuttaPidennetty2 = koskiSpecificOppijat.oppija("Pidennetty2", "Maksuttomuutta2", "220835-2325", syntymäaika = Some(LocalDate.of(2004, 1, 1)), kotikunta = Some(Kunta.helsinki))
  val vuonna2004SyntynytPeruskouluValmis2021 = koskiSpecificOppijat.oppija("Vuonna 2004 syntynyt", "Peruskoulu suoritettu 2021", "010104A153D", syntymäaika = Some(LocalDate.of(2004, 1, 1)), kotikunta = Some(Kunta.helsinki),
    kuntahistoriaMock = h => {
      val historia = Seq(
        OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, Kunta.helsinki, Some(LocalDate.of(2010, 1, 1)), None)
      )
      OppijanKuntahistoria(
        Some(h.henkilö.oid),
        historia,
  ...
  val vuonna2004SyntynytMuttaPeruskouluValmisEnnen2021 = koskiSpecificOppijat.oppija("Vuonna 2004 syntynyt", "Peruskoulu suoritettu ennen 2021", "010104A811M", syntymäaika = Some(LocalDate.of(2004, 1, 1)), kotikunta = Some(Kunta.helsinki),
    kuntahistoriaMock = h => {
      val historia = Seq(
        OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, Kunta.helsinki, Some(LocalDate.of(2010, 1, 1)), None)
      )
  ...
  val vuonna2005SyntynytEiOpiskeluoikeuksiaFikstuurissa = koskiSpecificOppijat.oppija("Vuonna 2005 syntynyt", "Ei opiskeluoikeuksia fikstuurissa", "030705A5719", syntymäaika = Some(LocalDate.of(2005, 7, 3)), kotikunta = Some(Kunta.helsinki))
  ...
  val vuonna2005SyntynytPeruskouluValmis2021 = koskiSpecificOppijat.oppija("Vuonna 2005 syntynyt", "Peruskoulu suoritettu 2021", "251105A2755", syntymäaika = Some(LocalDate.of(2005, 1, 1)), kotikunta = Some(Kunta.helsinki))
  ...
  val vuonna2004SyntynytMuttaEronnutPeruskoulustaEnnen2021 = koskiSpecificOppijat.oppija("Vuonna 2004 syntynyt", "Peruskoulusta eronnut ennen 2021", "100504A476V", syntymäaika = Some(LocalDate.of(2004, 5, 10)), kotikunta = Some(Kunta.helsinki))
  val opiskeleeAmmatillisessaErityisoppilaitoksessa = koskiSpecificOppijat.oppija("Erityisoppilaitoksessa", "Emppu", "210205A835C", syntymäaika = Some(LocalDate.of(2005, 2, 21)), kotikunta = Some(Kunta.helsinki))
  val opiskeleeAmmatillisessaErityisoppilaitoksessaOrganisaatioHistoriallinen = koskiSpecificOppijat.oppija("Erityisoppilaitoksessa", "Emppu Historia", "210905A671R", syntymäaika = Some(LocalDate.of(2005, 9, 5)), kotikunta = Some(Kunta.helsinki))
  ...
  val ylioppilasLukiolainenRikki = koskiSpecificOppijat.oppija("Rikko-Toikkarinen", "Risto", "280100A855E", kotikunta = Some(Kunta.helsinki),
    kuntahistoriaMock = h => {
      val historia = Seq(
        OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, "178", Some(LocalDate.of(2024, 1, 1)), Some(LocalDate.of(2024, 6, 1)))
      )
  ...
  val opiskeleeAmmatillisessaErityisoppilaitoksessa2 = koskiSpecificOppijat.oppija("Erityisoppilaitoksessa", "Emppu", "211005A867V", syntymäaika = Some(LocalDate.of(2005, 2, 21)), kotikunta = Some(Kunta.helsinki))
  ...
  val pelkkäYoKannassaUudenOvLainPiirissä = koskiSpecificOppijat.oppija("YO-opiskeluoikeus", "Valpas", "060807A7787", syntymäaika = Some(LocalDate.of(2007, 8, 6)), kotikunta = Some(Kunta.helsinki))
  ...
  val suomeenTäysiikäisenäMuuttanut = koskiSpecificOppijat.oppija("Jenkins", "Jenny", "010106A1328", kotikunta = Some(Kunta.helsinki),
    kuntahistoriaMock = h => {
      val historia = Seq(
        OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, Kunta.kotikuntaUlkomailla, Some(LocalDate.of(2006, 1, 1)), Some(LocalDate.of(2024, 3, 1))),
        OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, Kunta.helsinki, Some(LocalDate.of(2024, 3, 1)), None),
      )
      OppijanKuntahistoria(
        Some(h.henkilö.oid),
        historia,
  ...
  val suomeenAlaikäisenäMuuttanut = koskiSpecificOppijat.oppija("Anderson", "Andrew", "010106A8159", kotikunta = Some(Kunta.helsinki),
    kuntahistoriaMock = h => {
    val historia = Seq(
      OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, Kunta.kotikuntaUlkomailla, None,                           Some(LocalDate.of(2022, 3, 1))),
      OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, Kunta.helsinki,            Some(LocalDate.of(2022, 3, 1)), None),
    )
    OppijanKuntahistoria(
      Some(h.henkilö.oid),
      historia,
  ...
  val ulkomaillaHetkenAsunut = koskiSpecificOppijat.oppija("Matkailija", "Matilda", "010106A604F", kotikunta = Some(Kunta.helsinki),
    kuntahistoriaMock = h => {
      val historia = Seq(
        OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, Kunta.helsinki, Some(LocalDate.of(2006, 1, 1)), Some(LocalDate.of(2024, 3, 1))),
        OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, Kunta.kotikuntaUlkomailla, Some(LocalDate.of(2022, 3, 1)), Some(LocalDate.of(2024, 3, 1))),
        OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, Kunta.helsinki, Some(LocalDate.of(2024, 3, 1)), None)
      )
      OppijanKuntahistoria(
        Some(h.henkilö.oid),
  ...
  val suomeenAhvenanmaaltaTäysiikäisenäMuuttanut = koskiSpecificOppijat.oppija("Anderson", "Anders", "010106A0398", kotikunta = Some(Kunta.helsinki),
    kuntahistoriaMock = h => {
      val historia = Seq(
  ...
  val vapaaSivistystyöMaksuttomuus = koskiSpecificOppijat.oppija("VST", "Maksuttomuus", "311204A059L", syntymäaika = Some(LocalDate.of(2004, 12, 31)), kotikunta = Some(Kunta.helsinki))
  val vuonna2003SyntynytPeruskouluValmis2021 = koskiSpecificOppijat.oppija("Vuonna 2003 syntynyt", "Peruskoulu suoritettu 2021", "010103A3373", syntymäaika = Some(LocalDate.of(2003, 1, 1)), kotikunta = Some(Kunta.helsinki),
    kuntahistoriaMock = h => {
      val historia = Seq(
        OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, Kunta.helsinki, Some(LocalDate.of(2010, 1, 1)), None)
      )
  ...
  val vuonna2004SyntynytPeruskouluValmis2021MuuttanutSuomeenTäysiIkäisenä = koskiSpecificOppijat.oppija("Vuonna 2004 syntynyt (muuttanut Suomeen täysi-ikäisenä)", "Peruskoulu suoritettu 2021", "010104A3304", syntymäaika = Some(LocalDate.of(2004, 1, 1)), kotikunta = Some(Kunta.helsinki),
    kuntahistoriaMock = h => {
      val historia = Seq(
        OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, "478", Some(LocalDate.of(2004, 1, 1)), Some(LocalDate.of(2024, 2, 1))),
        OppijanumerorekisteriKotikuntahistoriaRow(h.henkilö.oid, Kunta.helsinki, Some(LocalDate.of(2024, 2, 1)), None)
      )
      OppijanKuntahistoria(
        Some(h.henkilö.oid),
        historia,
  ...
  val vainMitätöityjäOpiskeluoikeuksia = koskiSpecificOppijat.oppija("Mitätön", "Minna", "010106A492V", syntymäaika = Some(LocalDate.of(2006, 1, 1)), kotikunta = Some(Kunta.helsinki))
  val lahdejarjestelmanPurku = koskiSpecificOppijat.oppija("Purettava", "Lasse", "010106A013D", syntymäaika = Some(LocalDate.of(2006, 1, 1)), kotikunta = Some(Kunta.helsinki))
  ...
  val kielitutkinnonSuorittaja = koskiSpecificOppijat.oppija("Kielitutkinto imi Sukunimisukunimi sukusukuni", "Suorittaja iminim Niminimi Niminiminimin", "010107A329V", syntymäaika = Some(LocalDate.of(2007, 1, 1)))
  ...
  val pelkkäYo2021 = koskiSpecificOppijat.oppija("Pelkkä YO", "Koski", "300805A847D", syntymäaika = Some(LocalDate.of(2005,8,30)),kotikunta = Some(Kunta.helsinki))
  ...
  val kelaPerusopetusUusillaLisätiedoilla = koskiSpecificOppijat.oppija("Kelalle-Perusopetus", "Uudet-Lisätiedot", "150800A411C")
  ...
  val kotikuntalaskelmaKuusivuotias = koskiSpecificOppijat.oppija("Kuusi", "Kaisa", "010320A9012", syntymäaika = Some(LocalDate.of(2020, 3, 1)), kotikunta = Some(Kunta.jyväskylä))
  val kotikuntalaskelmaSeitsemanKaksitoista = koskiSpecificOppijat.oppija("SeitsemanKaksitoista", "Sami", "120517A9013", syntymäaika = Some(LocalDate.of(2017, 5, 12)), kotikunta = Some(Kunta.helsinki))
  val kotikuntalaskelmaKolmetoistaViisitoista = koskiSpecificOppijat.oppija("KolmetoistaViisitoista", "Kalle", "200912A9014", syntymäaika = Some(LocalDate.of(2012, 9, 20)), kotikunta = Some(Kunta.helsinki))
  val kotikuntalaskelmaKuusitoistaErityinen = koskiSpecificOppijat.oppija("KuusitoistaErityinen", "Essi", "140210A9015", syntymäaika = Some(LocalDate.of(2010, 2, 14)), kotikunta = Some(Kunta.jyväskylä))
  val kotikuntalaskelmaKuusitoistaEiErityista = koskiSpecificOppijat.oppija("KuusitoistaEiErityista", "Ilmari", "031110A9016", syntymäaika = Some(LocalDate.of(2010, 11, 3)), kotikunta = Some(Kunta.helsinki))
  ...
  // Turvakielto = true + oikea kotikunta (ei None): testaa että Kotikuntalaskelman
  // turvakielto-suoja (ks. Kotikuntalaskelma.scala) todella piilottaa kotikunnan/nimet/oidin
  // sen sijaan että kotikunta vain sattuisi puuttumaan muutenkin. kuntahistoriaDefault reitittää
  // tämän automaattisesti turvakieltoKuntahistoriat-karttaan (confidential), koska turvakielto=true.
  val kotikuntalaskelmaTurvakielto = koskiSpecificOppijat.oppija("Turvakielto", "Lapsi", "120416A9017", turvakielto = true, syntymäaika = Some(LocalDate.of(2016, 4, 12)), kotikunta = Some(Kunta.helsinki))
  // Toinen turvakielto-oppija, samassa koulutustoimijassa (Jyväskylä) kuin muitakin
  // testioppijoita, jotta demoissa näkyy ettei useampi "Turvakielto"-rivi samalla
  // koulutustoimijalla ole virhe vaan tarkoituksellinen, toisistaan erottamaton naamiointi.
  val kotikuntalaskelmaTurvakielto2 = koskiSpecificOppijat.oppija("Turvakielto", "Toinen-Lapsi", "090919A9011", turvakielto = true, syntymäaika = Some(LocalDate.of(2019, 9, 9)), kotikunta = Some(Kunta.jyväskylä))
  // Kotiopetus-jaksollinen oppija: testaa että "not aj.kotiopetus" todella rajaa kotiopetuksessa
  // olevat pois raportilta, vaikka muuten täyttäisivät kaikki muut ehdot (ikä, koulutusmuoto, tila).
  val kotikuntalaskelmaKotiopetus = koskiSpecificOppijat.oppija("Kotiopetus", "Kerttu", "100316A9012", syntymäaika = Some(LocalDate.of(2016, 3, 10)), kotikunta = Some(Kunta.jyväskylä))
  // Esiopetusoppija: testaa raportin esiopetus-haaraa (esiopetuksensuoritus + koulutusmuoto =
  // 'esiopetus'), joka on täysin oma, perusopetuksesta erillinen kysely-/aikajaksopolkunsa
  // (esiopetus_opiskeluoik_aikajakso).
  val kotikuntalaskelmaEsiopetus = koskiSpecificOppijat.oppija("Esiopetus", "Elias", "200520A9015", syntymäaika = Some(LocalDate.of(2020, 5, 20)), kotikunta = Some(Kunta.helsinki))
