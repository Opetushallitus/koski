...
case class TuvaPerusopetuksenOppijamäärätAikajaksovirheetRaportti(db: DB, organisaatioService: OrganisaatioService) extends TuvaPerusopetuksenOppijamääristäRaportoiva {
  implicit private val getResult: GetResult[TuvaPerusopetuksenOppijamäärätAikajaksovirheetRaporttiRow] = GetResult(r =>
...
case class TuvaPerusopetuksenOppijamäärätAikajaksovirheetRaporttiRow(
