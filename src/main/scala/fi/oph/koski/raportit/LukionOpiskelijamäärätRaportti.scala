...
case class LukionOpiskelijamäärätRaportti(repository: LukioRaportitRepository) extends GlobalExecutionContext {
...
case class LukionOpiskelijamäärätRaporttiOppiaineetVälilehtiMuut(
...
case class LukionOpiskelijamäärätRaporttiKaikkiOppiaineetVälilehtiRow(muut: LukioRaporttiOppiaineetVälilehtiMuut, oppiaineet: Seq[String]) {
