...
case class OpiskelijavuositiedotRow(
  ...
  opiskelijavuosikertymä2026: Option[Double],
...
object AmmatillinenOpiskalijavuositiedotRaportti extends AikajaksoRaportti {
  ...
  def columnSettings(t: LocalizationReader): Seq[(String, Column)] = Seq(
    ...
    "opiskelijavuosikertymä2026" -> Column(t.get("raportti-excel-kolumni-opiskelijavuosikertymä2026"), width = Some(2000), comment = Some(t.get("raportti-excel-kolumni-opiskelijavuosikertymä2026-comment"))),
