...
case class PerusopetuksenLisäopetusOppijamäärätRaportti(db: DB, organisaatioService: OrganisaatioService) extends KoskiDatabaseMethods {
  ...
  val columnSettings: Seq[(String, Column)] = Seq(
    ...
    "pidennettyOppivelvollisuusJaVaikeastiVammainen" -> Column("Perusopetuksen lisäopetuksen oppilaat, joille löytyy opiskeluoikeuden lisätiedoista raportin tulostusparametreissa määritellylle päivälle osuva pidennetyn oppivelvollisuuden ja vaikean vammaisuuden jakso"),
    "pidennettyOppivelvollisuusJaMuuKuinVaikeimminVammainen" -> Column("Perusopetuksen lisäopetuksen oppilaat, joille löytyy opiskeluoikeuden lisätiedoista raportin tulostusparametreissa määritellylle päivälle osuva pidennetyn oppivelvollisuuden ja muun kuin vaikean vammaisuuden jakso"),
