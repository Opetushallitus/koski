...
case class AikuistenPerusopetuksenOppijamäärätRaportti(db: DB, organisaatioService: OrganisaatioService) extends QueryMethods {
  ...
  def columnSettings(t: LocalizationReader): Seq[(String, Column)] = Seq(
    ...
    "aineopiskelijoitaVOS" -> Column(t.get("raportti-excel-kolumni-aineopiskelijoitaVOS"), comment = Some(t.get("raportti-excel-kolumni-aineopiskelijoitaVOS-AikuistenPerusopetus-comment"))),
    "aineopiskelijoitaMuuKuinVOS" -> Column(t.get("raportti-excel-kolumni-aineopiskelijoitaMuuKuinVOS"), comment = Some(t.get("raportti-excel-kolumni-aineopiskelijoitaMuuKuinVOS-AikuistenPerusopetus-comment"))),
