...
with oppija as (select
  ...
  val columnSettings: Seq[(String, Column)] = Seq(
    ...
    "oppimaaranSuorittajia_YliKolmeVuotta_VOSRahoitteisia" -> CompactColumn("oppimaaranSuorittajia_NeljannenVuodenOpiskelijoita"),
    ...
    "nuortenOppimaaranSuorittajia_YliKolmeVuotta_VOSRahoitteisia" -> CompactColumn("nuortenOppimaaranSuorittajia_NeljannenVuodenOpiskelijoita"),
    ...
    "aikuistenOppimaaranSuorittajia_YliKolmeVuotta_VOSRahoitteisia" -> CompactColumn("aikuistenOppimaaranSuorittajia_NeljannenVuodenOpiskelijoita"),
