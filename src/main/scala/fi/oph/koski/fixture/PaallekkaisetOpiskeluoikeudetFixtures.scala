...
import fi.oph.koski.schema.{AmmatillinenOpiskeluoikeudenTila, AmmatillinenOpiskeluoikeusjakso, AmmatillisenTutkinnonSuoritus, Oppilaitos, VapaanSivistystyönOpiskeluoikeudenTila, VapaanSivistystyönOpiskeluoikeusjakso}
...
object PaallekkaisetOpiskeluoikeudetFixtures {
  ...
  val vstVapaatavoitteinenOpiskeluoikeus = VapaaSivistystyöExample.opiskeluoikeusVapaatavoitteinen.copy(
    ...
    tila = VapaanSivistystyönOpiskeluoikeudenTila(List(
      VapaanSivistystyönOpiskeluoikeusjakso(keskimmaisenAlkamispaiva, VapaaSivistystyöExample.opiskeluoikeusHyväksytystiSuoritettu)
    )),
    suoritukset = List(
