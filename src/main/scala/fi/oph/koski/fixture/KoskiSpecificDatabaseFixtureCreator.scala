...
class KoskiSpecificDatabaseFixtureCreator(application: KoskiApplication) extends DatabaseFixtureCreator(application, "opiskeluoikeus_fixture", "opiskeluoikeushistoria_fixture") {
  ...
  protected def defaultOpiskeluOikeudet: List[(OppijaHenkilö, KoskeenTallennettavaOpiskeluoikeus)] = {
    List(
      ...
      (KoskiSpecificMockOppijat.osittainenAmmattitutkintoUseastaTutkinnostaValmis, AmmatillinenOsittainenUseistaTutkinnoista.valmisUseastaTutkinnostaOpiskeluoikeus),
      (KoskiSpecificMockOppijat.osittainenAmmattitutkintoUseastaTutkinnostaKesken, AmmatillinenOsittainenUseistaTutkinnoista.keskeneräinenUseastaTutkinnostaOpiskeluoikeus),
      ...
      (KoskiSpecificMockOppijat.kielitutkinnonSuorittaja, ExamplesKielitutkinto.ValtionhallinnonKielitutkinnot.Opiskeluoikeus.epäonnistuneestiUusittu(LocalDate.of(2022, 8, 12), "SV", List("kirjallinen"), "hyvajatyydyttava")),
      (KoskiSpecificMockOppijat.kielitutkintoTodistusVirhe, ExamplesKielitutkinto.YleisetKielitutkinnot.opiskeluoikeus(LocalDate.of(2023, 1, 1), "FI", "kt")),
      (KoskiSpecificMockOppijat.kielitutkintoEnnenRajapäivää, ExamplesKielitutkinto.YleisetKielitutkinnot.opiskeluoikeus(LocalDate.of(2009, 1, 3), "FI", "kt")),
