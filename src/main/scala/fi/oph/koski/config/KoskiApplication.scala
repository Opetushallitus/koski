...
import fi.oph.koski.kyselyt.KyselyService
...
class KoskiApplication(
  ...
  lazy val opintopolkuHenkilöFacade = OpintopolkuHenkilöFacade(config, masterDatabase.db, hetu, perustiedotRepository, perustiedotIndexer)
