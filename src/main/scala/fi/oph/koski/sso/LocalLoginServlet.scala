...
class LocalLoginServlet(implicit val application: UserAuthenticationContext) extends ApiServlet with KoskiAuthenticationSupport with KoskiSSOSupport with NoCache {
  post("/") {
