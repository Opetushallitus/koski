...
object MockUsers {
  ...
  val ytlKäyttäjä = KoskiMockUser("YTL-virkailija", "ylermi", "1.2.246.562.24.42042042058", Set(KäyttöoikeusViranomainen(List(Palvelurooli(YTL), Palvelurooli(GLOBAALI_LUKU_TOINEN_ASTE)))))
