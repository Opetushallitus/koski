...
object MockUsers {
  ...
  val stadinAmmattiopistoPalvelukäyttäjä = MockUser(LdapUser(List(), "stadin-palvelu", "stadin-palvelu", "98371"), Set((MockOrganisaatiot.stadinAmmattiopisto, oppilaitosPalvelukäyttäjä)))
  ...
  val stadinVastuukäyttäjä = MockUser(LdapUser(List(), "stadin-vastuu", "stadin-vastuu", "00160"), Set((MockOrganisaatiot.stadinAmmattiopisto, vastuukäyttäjä)))
