...
object Rooli {
  ...
  val OMADATAOAUTH2_OPISKELUOIKEUDET_KAIKKI_TIEDOT_JA_VALINTATIEDOT = "OMADATAOAUTH2_OPISKELUOIKEUDET_KAIKKI_TIEDOT_JA_VALINTATIEDOT"
  ...
  val AHVENANMAANPERUSOPETUS = "AHVENANMAANPERUSOPETUS" // Ei käyttöoikeus-palvelussa
