...
object KoskiAuditLogMessage {
  ...
  def apply(operation: KoskiOperation, session: Session, extraFields: AuditLogMessage.ExtraFields): AuditLogMessage = {
...
object KoskiOperation extends Enumeration {
  ...
  SUORITUSPALVELU_OPISKELUOIKEUS_HAKU,
  KIOS_OPISKELUOIKEUS_HAKU,
  HAKEMUSPALVELU_OPISKELUOIKEUS_HAKU,
  LAHDEJARJESTELMAKYTKENNAN_PURKAMINEN,
  OAUTH2_ACCESS_TOKEN_LUONTI,
  OAUTH2_KATSOMINEN_KAIKKI_TIEDOT_JA_VALINTATIEDOT,
