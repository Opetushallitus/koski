...
object KelaKorkeakoulunOpiskeluoikeus {
  ...
  private def suoritus(s: schema.KorkeakouluSuoritus): KelaKorkeakoulunPäätasonSuoritus = s match {
    ...
    case o: schema.KorkeakoulunOpintojaksonSuoritus => KelaKorkeakoulunOpintojaksonSuoritus(
      ...
      laji = o.laji.map(KelaKoodistokoodiviite.fromKoskiSchema),
      lähdeorganisaatio = o.lähdeorganisaatio.map(lähdeorganisaatio),
  ...
  private def lähdeorganisaatio(l: schema.KorkeakoulunLähdeorganisaatio) = KelaKorkeakoulunLähdeorganisaatio(
    koodi = l.koodi,
    oppilaitos = l.oppilaitos.map(oppilaitos)
  )
...
case class KelaKorkeakoulunLähdeorganisaatio(
...
case class KelaKorkeakoulunOpintojaksonSuoritus(
  ...
  laji: Option[KelaKoodistokoodiviite],
  lähdeorganisaatio: Option[KelaKorkeakoulunLähdeorganisaatio],
  @Description("Opintosuorituksen julkinen lisätieto")
  @SensitiveData(Set(Rooli.LUOTTAMUKSELLINEN_KELA_LAAJA))
  lisätieto: Option[schema.LocalizedString],
