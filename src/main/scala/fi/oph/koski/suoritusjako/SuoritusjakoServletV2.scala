...
class SuoritusjakoServletV2(implicit val application: KoskiApplication) extends EditorApiServlet with KoskiAuthenticationSupport with Logging with NoCache {
