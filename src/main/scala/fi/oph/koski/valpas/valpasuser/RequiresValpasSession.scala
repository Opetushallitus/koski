...
import fi.oph.koski.koskiuser.{AuthenticationSupport, HasKoskiSession, KoskiSession}

trait RequiresValpasSession extends AuthenticationSupport with HasKoskiSession {
