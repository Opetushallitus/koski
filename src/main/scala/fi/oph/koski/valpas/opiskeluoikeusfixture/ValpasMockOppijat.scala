...
object ValpasMockOppijat {
  ...
  val peruskoulustaLokakuussaValmistunutIlman9Luokkaa = valpasOppijat.oppijaSyntymäaikaHetusta("Valmistunut-lokakuussa-ei-ysiluokkaa", "Valpas", "110505A1818")
  val lukioVanhallaOpsilla = valpasOppijat.oppijaSyntymäaikaHetusta("LukioVanhallaOpsilla", "Valpas", "060704A687P")
  val oppivelvollinenIntSchoolYsiluokkaKeskenKeväällä2021 = valpasOppijat.oppijaSyntymäaikaHetusta("Oppivelvollinen-int-school-kesken-keväällä-2021", "Valpas", "180205A026B")
  val intSchoolKasiluokkaKeskenKeväällä2021 = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-kasiluokka-kesken-keväällä-2021", "Valpas", "030705A638E")
  val intSchool9LuokaltaKeskenEronnutOppija =valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-9-luokalta-kesken-eroaja-aiemmin", "Valpas", "180205A6682")
  val intSchool9LuokaltaKeskenEronnutOppijaTarkastelupäivänä = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-9-luokalta-kesken-eroaja-samana-päivänä", "Valpas", "150905A020V")
  val intSchool9LuokaltaKeskenEronnutOppijaTarkastelupäivänJälkeen = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-9-luokalta-kesken-eroaja-myöhemmin", "Valpas", "210405A014H")
  val intSchool9LuokaltaValmistumisenJälkeenEronnutOppija = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-9-luokalta-valmistumisen-jälkeen-eronnut-aiemmin", "Valpas", "170405A683H")
  val intSchool9LuokaltaValmistumisenJälkeenEronnutOppijaTarkastelupäivänä = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-9-luokalta-valmistumisen-jälkeen-eronnut-samana-päivänä", "Valpas", "090905A633S")
  val intSchool9LuokaltaValmistumisenJälkeenEronnutOppijaTarkastelupäivänJälkeen = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-9-luokalta-valmistumisen-jälkeen-eronnut-myöhemmin", "Valpas", "100705A034F")
  val intSchool9LuokanJälkeenLukionAloittanut = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-9-luokan-jälkeen-lukion-aloittanut", "Valpas", "120505A3434")
  val intSchool9LuokanJälkeenIntSchoolin10LuokallaAloittanut = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-9-luokan-jälkeen-int-schoolin-10-luokalla-aloittanut", "Valpas", "220205A6867")
  val intSchool9LuokanJälkeenLukionLokakuussaAloittanut = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-9-luokan-jälkeen-lukion-lokakuussa-aloittanut", "Valpas", "070105A7969")
  val intSchool9LuokanJälkeenIntSchoolin10LuokallaLokakuussaAloittanut = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-9-luokan-jälkeen-int-schoolin-10-luokalla-lokakuussa-aloittanut", "Valpas", "080405A722Y")
  val intSchoolin9LuokaltaYli2kkAiemminValmistunut = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-yli-2kk-aiemmin-9-valmistunut", "Valpas", "231005A872A")
  val intSchoolin9LuokaltaYli2kkAiemminValmistunut10Jatkanut = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-yli-2kk-aiemmin-9-valmistunut-10-jatkanut", "Valpas", "111105A3651")
  val intSchoolistaEronnutMaaliskuussa17VuottaTäyttäväKasiluokkalainen = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-eronnut-maaliskuussa-17-vuotta-täyttävä-8-luokkalainen", "Valpas", "100304A1358")
  val intSchoolistaEronnutElokuussa17VuottaTäyttäväKasiluokkalainen = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-eronnut-elokuussa-17-vuotta-täyttävä-8-luokkalainen", "Valpas", "220804A101X")
  val intSchool10LuokaltaAloittanut = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-10-luokalta-aloittanut", "Valpas", "090605A676R")
  val intSchool11LuokaltaAloittanut = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-11-luokalta-aloittanut", "Valpas", "050405A222W")
  val intSchool8LuokanSyksyllä2021Aloittanut = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-8-luokan-syksyllä-2021-aloittanut", "Valpas", "040305A8601")
  val intSchool9LuokanSyksyllä2021Aloittanut = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-9-luokan-syksyllä-2021-aloittanut", "Valpas", "210805A187A")
  val intSchoolLokakuussaPerusopetuksenSuorittanut = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-9-vahvistettu-lokakuussa", "Valpas", "221105A467D")
  val intSchool10LuokallaIlmanAlkamispäivää = valpasOppijat.oppijaSyntymäaikaHetusta("Int-school-10-luokalla-ilman-alkamispäivää", "Valpas", "140305A455D")
