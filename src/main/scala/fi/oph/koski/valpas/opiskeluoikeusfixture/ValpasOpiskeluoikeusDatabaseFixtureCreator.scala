...
class ValpasOpiskeluoikeusDatabaseFixtureCreator(application: KoskiApplication) extends DatabaseFixtureCreator(application, "opiskeluoikeus_valpas_fixture", "opiskeluoikeushistoria_valpas_fixture") {
  ...
  protected def defaultOpiskeluOikeudet: List[(OppijaHenkilö, KoskeenTallennettavaOpiskeluoikeus)] = List(
    ...
    (ValpasMockOppijat.eiOppivelvollinenLukuvuosimaksuRahoitteinen, ValpasOpiskeluoikeusExampleData.valmistunutYsiluokkalainen),
    (ValpasMockOppijat.eiOppivelvollinenLukuvuosimaksuRahoitteinen, ValpasOpiskeluoikeusExampleData.ammattikouluLukuvuosimaksuOpiskeluoikeus),
    ...
    (ValpasMockOppijat.valmistunutYsiluokkalainenTavoitekokonaisuuksittainOpiskelu, ValpasOpiskeluoikeusExampleData.valmistunutYsiluokkalainenTako),
    (ValpasMockOppijat.ysiluokkaKeskenTavoitekokonaisuuksittainOpiskelu, ValpasOpiskeluoikeusExampleData.ysiluokkaKeskenTako),
    ...
    (ValpasMockOppijat.hakukoosteenHakuAinaEpäonnistuvaOppija, ValpasOpiskeluoikeusExampleData.oppivelvollinenYsiluokkaKeskenKeväällä2021SaksalainenKouluOpiskeluoikeus),
    ...
    (ValpasMockOppijat.lukioOpinnotAmmattitutkinnonJalkeen, ValpasOpiskeluoikeusExampleData.poistaLukionModuulienOsasuoritukset(ValpasOpiskeluoikeusExampleData.lukionOpiskeluoikeus(LocalDate.of(2021, 9, 6))).withLisääPuuttuvaMaksuttomuustieto),
    ...
    (ValpasMockOppijat.ulkomailtaAlle18vuotiaanaMuuttanutJaSuomessaMuuttanut, ValpasOpiskeluoikeusExampleData.oppivelvollinenYsiluokkaKeskenKeväällä2021Opiskeluoikeus),
