...
class ValpasOpiskeluoikeusDatabaseFixtureCreator(application: KoskiApplication) extends DatabaseFixtureCreator(application, "opiskeluoikeus_valpas_fixture", "opiskeluoikeushistoria_valpas_fixture") {
  ...
  protected def defaultOpiskeluOikeudet: List[(OppijaHenkilö, KoskeenTallennettavaOpiskeluoikeus)] = List(
    ...
    (ValpasMockOppijat.ammattitutkintoYoTutkinnonJalkeen, ValpasOpiskeluoikeusExampleData.lukionOpiskeluoikeusValmistunut),
    (ValpasMockOppijat.ammattitutkintoYoTutkinnonJalkeen, ValpasOpiskeluoikeusExampleData.keskeneräinenAmmattitutkinnonOpiskeluoikeus),
    ...
    (ValpasMockOppijat.lukioOpinnotAmmattitutkinnonJalkeen, ValpasOpiskeluoikeusExampleData.ammattikouluValmistunutOpiskeluoikeus(LocalDate.of(2019, 8, 1), LocalDate.of(2021, 9, 5))),
    (ValpasMockOppijat.lukioOpinnotAmmattitutkinnonJalkeen, ValpasOpiskeluoikeusExampleData.lukionOpiskeluoikeus(LocalDate.of(2021, 9, 6))),
  )
