...
class ValpasOpiskeluoikeusDatabaseFixtureCreator(application: KoskiApplication) extends DatabaseFixtureCreator(application, "opiskeluoikeus_valpas_fixture", "opiskeluoikeushistoria_valpas_fixture") {
  ...
  protected def defaultOpiskeluOikeudet: List[(OppijaHenkilö, KoskeenTallennettavaOpiskeluoikeus)] = List(
    ...
    (ValpasMockOppijat.amisEronnutUusiOpiskeluoikeusTulevaisuudessa, ValpasOpiskeluoikeusExampleData.valmistunutYsiluokkalainenSaksalainenKoulu),
    (ValpasMockOppijat.amisEronnutUusiOpiskeluoikeusTulevaisuudessa, ValpasOpiskeluoikeusExampleData.ammattikouluEronnutOpiskeluoikeus),
    (ValpasMockOppijat.amisEronnutUusiOpiskeluoikeusTulevaisuudessa, ValpasOpiskeluoikeusExampleData.ammattikouluAlkaaOmniaLoka2021),
    ...
    (ValpasMockOppijat.amisEronnutUusiOpiskeluoikeusPeruskoulussa, ValpasOpiskeluoikeusExampleData.valmistunutYsiluokkalainenSaksalainenKoulu),
    (ValpasMockOppijat.amisEronnutUusiOpiskeluoikeusPeruskoulussa, ValpasOpiskeluoikeusExampleData.ammattikouluEronnutOpiskeluoikeus),
    (ValpasMockOppijat.amisEronnutUusiOpiskeluoikeusPeruskoulussa, ValpasOpiskeluoikeusExampleData.alkaaYsiluokkalainenSaksalainenKouluSyys2021),
