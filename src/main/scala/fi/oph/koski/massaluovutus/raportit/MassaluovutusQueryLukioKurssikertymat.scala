...
case class MassaluovutusQueryLukioKurssikertymat(
...
) extends MassaluovutusRaporttiBase[MassaluovutusQueryLukioKurssikertymat] {

  override def opiskeluoikeudenTyyppi = OpiskeluoikeudenTyyppi.lukiokoulutus
  override def raporttiName = "lukiokurssikertymat"
  ...
  override protected def generateReport(
    ...
    raportitService.lukioKoulutuksenKurssikertyma(request, localizationReader)
  }
