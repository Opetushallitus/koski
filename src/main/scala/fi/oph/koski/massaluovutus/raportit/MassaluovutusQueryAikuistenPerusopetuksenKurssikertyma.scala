...
case class MassaluovutusQueryAikuistenPerusopetuksenKurssikertyma(
...
) extends MassaluovutusRaporttiBase[MassaluovutusQueryAikuistenPerusopetuksenKurssikertyma] {

  override def opiskeluoikeudenTyyppi = OpiskeluoikeudenTyyppi.aikuistenperusopetus
  override def raporttiName = "aikuistenperusopetuksenkurssikertymaraportti"
  ...
  override protected def generateReport(
    ...
    raportitService.aikuistenperusopetuksenKurssikertymä(request, localizationReader)
  }
