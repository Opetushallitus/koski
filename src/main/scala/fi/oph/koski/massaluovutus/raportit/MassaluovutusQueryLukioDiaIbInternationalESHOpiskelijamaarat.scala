...
case class MassaluovutusQueryLukioDiaIbInternationalESHOpiskelijamaarat(
...
) extends MassaluovutusRaporttiBase[MassaluovutusQueryLukioDiaIbInternationalESHOpiskelijamaarat] {

  override def opiskeluoikeudenTyyppi = OpiskeluoikeudenTyyppi.lukiokoulutus
  override def raporttiName = "lukiodiaibinternationaleshopiskelijamaarat"
  ...
  override protected def generateReport(
    ...
    raportitService.lukioDiaIbInternationalESHOpiskelijaMaaratRaportti(request, localizationReader)
  }
