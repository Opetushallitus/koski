...
case class MassaluovutusQueryPerusopetukseenValmistava(
  ...
  override def raporttiName = "perusopetukseenvalmistavansuoritustietojentarkistus"
  ...
  override protected def generateReport(
    ...
    raportitService.perusopetukseenvalmistavanopetuksenraportti(request, localizationReader)
  }
