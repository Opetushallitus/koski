...
case class MassaluovutusQueryEsiopetuksenOppijamaaratRaportti(
...
) extends MassaluovutusRaporttiBase[MassaluovutusQueryEsiopetuksenOppijamaaratRaportti] {

  override def opiskeluoikeudenTyyppi = OpiskeluoikeudenTyyppi.esiopetus
  override def raporttiName = "esiopetuksenoppijamaaratraportti"
  ...
  override protected def generateReport(
    ...
    raportitService.esiopetuksenOppijamäärät(request, localizationReader)
  }
