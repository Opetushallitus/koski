...
case class MassaluovutusQueryPerusopetuksenLisaopetuksenOppijamaaratRaportti(
  ...
  override def raporttiName = "perusopetuksenlisaopetuksenoppijamaaratraportti"
  ...
  override protected def generateReport(
    ...
    raportitService.perusopetuksenLisäopetuksenOppijamäärät(request, localizationReader)
  }
