...
case class MassaluovutusQueryVSTJOTPA(
...
) extends MassaluovutusRaporttiBase[MassaluovutusQueryVSTJOTPA] {

  override def opiskeluoikeudenTyyppi = OpiskeluoikeudenTyyppi.vapaansivistystyonkoulutus
  override def raporttiName = "vstjotpa"
  ...
  override protected def generateReport(
    ...
    raportitService.vstJotpa(request, localizationReader)
  }
