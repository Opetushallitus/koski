...
case class MassaluovutusQueryTuvaPerusopetuksenOppijamaaratRaportti(
...
) extends MassaluovutusRaporttiBase[MassaluovutusQueryTuvaPerusopetuksenOppijamaaratRaportti] {

  override def opiskeluoikeudenTyyppi = OpiskeluoikeudenTyyppi.tuva
  override def raporttiName = "tuvaperusopetuksenoppijamaaratraportti"
  ...
  override protected def generateReport(
    ...
    raportitService.tuvaPerusopetuksenOppijamäärät(request, localizationReader)
  }
