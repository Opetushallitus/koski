...
case class MassaluovutusQueryLukionSuoritustiedot(
...
) extends MassaluovutusRaporttiBase[MassaluovutusQueryLukionSuoritustiedot] {

  override def opiskeluoikeudenTyyppi = OpiskeluoikeudenTyyppi.lukiokoulutus
  override def raporttiName = "lukionsuoritustietojentarkistus"
  ...
  override protected def generateReport(
    ...
    raportitService.lukioraportti(request, localizationReader)
  }
