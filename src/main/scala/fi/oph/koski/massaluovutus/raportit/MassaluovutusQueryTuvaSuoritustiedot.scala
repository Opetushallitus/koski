...
case class MassaluovutusQueryTuvaSuoritustiedot(
...
) extends MassaluovutusRaporttiBase[MassaluovutusQueryTuvaSuoritustiedot] {

  override def opiskeluoikeudenTyyppi = OpiskeluoikeudenTyyppi.tuva
  override def raporttiName = "tuvasuoritustietojentarkistus"
  ...
  override protected def generateReport(
    ...
    raportitService.tuvaSuoritustiedot(request, localizationReader)
  }
