...
case class MassaluovutusQueryAmmatillinenTutkintoSuoritustiedot(
  ...
  override def raporttiName = "ammatillinentutkintosuoritustietojentarkistus"
  ...
  override protected def generateReport(
    ...
    raportitService.ammatillinenTutkintoSuoritustietojenTarkistus(request, localizationReader)
  }
