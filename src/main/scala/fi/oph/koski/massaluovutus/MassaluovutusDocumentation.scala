...
import fi.oph.koski.massaluovutus.organisaationopiskeluoikeudet.{QueryOrganisaationOpiskeluoikeudetCsvDocumentation, QueryOrganisaationOpiskeluoikeudetJsonDocumentation, QueryOrganisaationOpiskeluoikeudetJsonV2Documentation}
...
object QueryExamples {
  ...
  def jsonByName(application: KoskiApplication, name: String): Option[String] = name match {
    ...
    case "OrganisaationOpiskeluoikeudetJsonV2" => asJson(QueryOrganisaationOpiskeluoikeudetJsonV2Documentation.example)
