...
import fi.oph.koski.massaluovutus.raportit.{QueryAikuistenPerusopetuksenKurssikertymaDocumentation, QueryAikuistenPerusopetuksenOppijamaaratRaporttiDocumentation, QueryAikuistenPerusopetusSuoritustiedotDocumentation, QueryAmmatillinenOpiskelijavuositiedotDocumentation, QueryAmmatillinenOsittainenSuoritustiedotDocumentation, QueryAmmatillinenTutkintoSuoritustiedotDocumentation, QueryEsiopetuksenOppijamaaratRaporttiDocumentation, QueryEsiopetusDocumentation, QueryIBSuoritustiedotDocumentation, QueryLukio2019OpintopistekertymatDocumentation, QueryLukio2019SuoritustiedotDocumentation, QueryLukioDiaIbInternationalESHOpiskelijamaaratDocumentation, QueryLukioKurssikertymatDocumentation, QueryLukionSuoritustiedotDocumentation, QueryMuuAmmatillinenDocumentation, QueryMuuKuinSaanneltyKoulutusDocumentation, QueryPerusopetukseenValmistavaDocumentation, QueryPerusopetuksenOppijamaaratRaporttiDocumentation, QueryPerusopetuksenVuosiluokkaDocumentation, QueryTOPKSAmmatillinenDocumentation, QueryTuvaPerusopetuksenOppijamaaratRaporttiDocumentation, QueryTuvaSuoritustiedotDocumentation, QueryVSTJOTPADocumentation}
