...
import fi.oph.koski.koskiuser.{LuovutuspalveluAuthenticationSupport, RequiresSuomiFiOrHsl}
import fi.oph.koski.schema.LocalizedString
import fi.oph.koski.servlet.NoCache

import scala.xml.{Elem, Node, NodeSeq}

class PalveluvaylaServlet(implicit val application: KoskiApplication) extends SoapServlet with RequiresSuomiFiOrHsl with LuovutuspalveluAuthenticationSupport with NoCache {
