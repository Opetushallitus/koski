...
import fi.oph.koski.schema.{Koodistokoodiviite, OpiskeluoikeudenOrganisaatiohistoria, Oppilaitos, PerusopetuksenLisäopetuksenOpiskeluoikeus, SisältäväOpiskeluoikeus}
