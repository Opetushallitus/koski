...
class RaportointikantaTestServlet(implicit val application: KoskiApplication) extends KoskiSpecificApiServlet with KoskiCookieAndBasicAuthenticationSupport with NoCache with ObservableSupport with ContentEncodingSupport {
