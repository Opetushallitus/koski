  ...
  private def buildROpiskeluoikeusAikajaksoRowForOneDay(opiskeluoikeusOid: String, o: KoskeenTallennettavaOpiskeluoikeus, päivä: LocalDate): Option[ROpiskeluoikeusAikajaksoRow] = {
    ...
    if (o.isInstanceOf[EsiopetuksenOpiskeluoikeus]) {
      ...
      Some(ROpiskeluoikeusAikajaksoRow(
        ...
        tavoitekokonaisuuksittainOpiskelu = lisätietoVoimassaPäivänä {
          case l: TavoitekokonaisuuksittainOpiskeleva => l.tavoitekokonaisuuksittainOpiskelu
        },
        valmistavanLisäopetus = lisätietoVoimassaPäivänä {
          case l: PerusopetuksenOpiskeluoikeudenLisätiedot => l.valmistavanLisäopetus
        }
      ))
    ...
    val lisätiedotAikajaksot: Seq[Jakso] = o.lisätiedot.collect {
      ...
      case pol: PerusopetuksenOpiskeluoikeudenLisätiedot =>
        toSeq(
          ...
          pol.tavoitekokonaisuuksittainOpiskelu,
          pol.valmistavanLisäopetus
        ) ++ Seq(
          pol.majoitusetu,
          pol.kuljetusetu,
