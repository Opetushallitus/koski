...
case class IdentifyingSetOfFields(oppijaOid: String, oppilaitosOrganisaatio: String, ePerusteetDiaarinumero: String) extends OpintoOikeusIdentifier {
  def this(oppijaOid: String, opintoOikeus: OpintoOikeus) = this(oppijaOid, opintoOikeus.oppilaitosOrganisaatio.oid, opintoOikeus.tutkinto.ePerusteetDiaarinumero)
}
