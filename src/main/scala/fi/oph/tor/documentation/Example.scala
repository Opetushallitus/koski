...
object Examples {
  val examples = ExamplesAmmatillinen.examples ++ ExamplesPerusopetus.examples ++ ExamplesPerusopetuksenLisaopetus.examples ++ ExamplesLukio.examples ++ ExamplesKorkeakoulu.examples
}
