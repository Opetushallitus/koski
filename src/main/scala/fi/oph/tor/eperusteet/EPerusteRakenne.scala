...
case class EPerusteRakenne(id: Long, nimi: Map[String, String], diaarinumero: String, koulutukset: List[EPerusteKoulutus], suoritustavat: List[ESuoritustapa], tutkinnonOsat: List[ETutkinnonOsa], osaamisalat: List[EOsaamisala])
