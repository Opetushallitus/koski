...
import fi.oph.tor.toruser.{AuthenticationSupport, RequiresAuthentication, UserOrganisationsRepository}
import fi.oph.tor.tutkinto.{SuoritustapaJaRakenne, TutkintoRakenne, TutkintoRepository}
import fi.vm.sade.security.ldap.DirectoryClient

class TodistusServlet(val userRepository: UserOrganisationsRepository, val directoryClient: DirectoryClient, rekisteri: TodennetunOsaamisenRekisteri, tutkintoRepository: TutkintoRepository) extends ErrorHandlingServlet with AuthenticationSupport {
