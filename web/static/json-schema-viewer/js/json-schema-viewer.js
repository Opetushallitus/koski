/*! JSON Schema Viewer v0.3.4 - For included libraries, see source for additional licensing info. | https://github.com/jlblcc/json-schema-viewer */(function(root, factory) {
    "use strict";
...
if (typeof tv4.asyncLoad === "undefined") {
    tv4.asyncLoad = function(uri, callback, uriPrefix) {
        var missing = uri instanceof Array ? uri : tv4.getMissingUris(), pref = uriPrefix || "";
...
!function(e) {
    ...
    function s(e) {
        ...
        function r(a, i) {
            if (!a.compiled) {
                ...
                a.lR = t(a.l || /\b\w+\b/, !0), i && (a.bK && (a.b = "\\b(" + a.bK.split(" ").join("|") + ")\\b"),
                a.b || (a.b = /\B|\b/), a.bR = t(a.b), a.e || a.eW || (a.e = /\B|\b/), a.e && (a.eR = t(a.e)),
                a.tE = n(a.e) || "", a.eW && i.tE && (a.tE += (a.e ? "|" : "") + i.tE)), a.i && (a.iR = t(a.i)),
                void 0 === a.r && (a.r = 1), a.c || (a.c = []);
                var s = [];
    ...
    function p(e) {
        ...
        if (!a(n)) {
            ...
            o.value = g(o.value), e.innerHTML = o.value, e.className = h(e.className, n, o.language),
            e.result = {
                language: o.language,
                re: o.r
    ...
    return e.highlight = f, e.highlightAuto = l, e.fixMarkup = g, e.highlightBlock = p,
    e.configure = d, e.initHighlighting = b, e.initHighlightingOnLoad = v, e.registerLanguage = m,
    e.listLanguages = N, e.getLanguage = w, e.inherit = o, e.IR = "[a-zA-Z]\\w*", e.UIR = "[a-zA-Z_]\\w*",
    ...
    var JSV = {
        ...
        init: function(config, callback) {
            ...
            $.fn.highlight = function(str, className, quote) {
                var string = quote ? '\\"\\b' + str + '\\b\\"' : "\\b" + str + "\\b", regex = new RegExp(string, "g");
                return this.each(function() {
            ...
            $("#info-panel").on("tabsactivate", function(event, ui) {
                ...
                if (id === "info-tab-example" || id === "info-tab-schema") {
                    var pre = ui.newPanel.find("pre"), highEl = pre.find("span.highlight")[0];
                    if (highEl) {
        ...
        contentHeight: function() {
            var screen = $.mobile.getScreenHeight(), header = $(".ui-header").hasClass("ui-header-fixed") ? $(".ui-header").outerHeight() - 1 : $(".ui-header").outerHeight(), footer = $(".ui-footer").hasClass("ui-footer-fixed") ? $(".ui-footer").outerHeight() - 1 : $(".ui-footer").outerHeight(), contentCurrent = $("#main-body.ui-content").outerHeight() - $("#main-body.ui-content").height(), content = screen - header - footer - contentCurrent;
        ...
        validate: function() {
            ...
            if (data) {
                var stop = $("#checkbox-stop").is(":checked"), strict = $("#checkbox-strict").is(":checked"), schema = tv4.getSchemaMap()[JSV.schema], result;
                if (stop) {
        ...
        buildValError: function(err, title) {
            var main = '<div data-role="collapsible" data-collapsed="true" data-mini="true">' + "<h4>" + (title || "Error: ") + err.message + "</h4>" + "<ul><li>Message: " + err.message + "</li>" + "<li>Data Path: " + err.dataPath + "</li>" + "<li>Schema Path: " + err.schemaPath + "</li></ul></div>";
            return $(main);
        },
        setInfo: function(node) {
            ...
            var height = $("#info-panel").innerHeight() - $("#info-panel .ui-panel-inner").outerHeight() + $("#info-panel #info-tabs").height() - $("#info-panel #info-tabs-navbar").height() - (schema.outerHeight(true) - schema.height());
        ...
        flashNode: function(node, times) {
            var t = times || 4, text = $("#n-" + node.id + " text");
            while (t--) {
        ...
        compileData: function(schema, parent, name, real, depth) {
            ...
            var key, node, s = schema.$ref ? tv4.getSchema(schema.$ref) : schema, props = s.properties, items = s.items, owns = Object.prototype.hasOwnProperty, all = {}, parentSchema = function(node) {
        ...
        centerNode: function(source, ratioX) {
            var rX = ratioX ? ratioX : 2, zl = JSV.zoomListener, scale = zl.scale(), x = -source.y0 * scale + JSV.viewerWidth / rX, y = -source.x0 * scale + JSV.viewerHeight / 2;
            d3.select("g#node-group").transition().duration(JSV.duration).attr("transform", "translate(" + x + "," + y + ")scale(" + scale + ")");
            zl.scale(scale);
            zl.translate([ x, y ]);
        },
        collapse: function(d) {
        ...
        interpolateZoom: function(translate, scale) {
            return d3.transition().duration(350).tween("zoom", function() {
                var iTranslate = d3.interpolate(JSV.zoomListener.translate(), translate), iScale = d3.interpolate(JSV.zoomListener.scale(), scale);
                return function(t) {
        ...
        zoomClick: function() {
            var clicked = d3.event.target, direction = 1, factor = .2, target_zoom = 1, center = [ JSV.viewerWidth / 2, JSV.viewerHeight / 2 ], zl = JSV.zoomListener, extent = zl.scaleExtent(), translate = zl.translate(), translate0 = [], l = [], view = {
                x: translate[0],
                y: translate[1],
                k: zl.scale()
            };
        ...
        diagonal1: function(d) {
            var src = d.source, node = d3.select("#n-" + src.id)[0][0], dia, width = 0;
            if (node) {
        ...
        update: function(source) {
            ...
            var nodes = JSV.tree.nodes(root), links = JSV.tree.links(nodes);
            ...
            nodeEnter.append("circle").attr("r", 0).classed("collapsed", function(d) {
            ...
            nodeEnter.append("text").attr("x", function(d) {
                return 10;
            }).attr("dy", ".35em").attr("class", function(d) {
            ...
            }).style("fill-opacity", 0).on("click", JSV.clickTitle).on("dblclick", function(d) {
                JSV.click(d);
                JSV.clickTitle(d);
                d3.event.stopPropagation();
            });
            node.select(".node circle").attr("r", 6.5).classed("collapsed", function(d) {
                return d._children ? true : false;
            });
        ...
        createDiagram: function(callback) {
            tv4.asyncLoad([ JSV.schema ], function() {
                ...
                JSV.zoomListener = d3.behavior.zoom().scaleExtent([ .1, 3 ]).on("zoom", JSV.zoom);
                JSV.baseSvg = d3.select("#main-body").append("svg").attr("id", "jsv-tree").attr("class", "overlay").attr("width", viewerWidth).attr("height", viewerHeight).call(JSV.zoomListener);
                ...
                legendItem.append("circle").attr("r", 6.5).attr("class", function(d) {
                    return d.iconCls;
                });
                legendItem.append("text").attr("x", 15).attr("dy", ".35em").attr("class", "item-text").attr("text-anchor", "start").style("fill-opacity", function(d) {
                    return d.opacity || 1;
                }).text(function(d) {
                    return d.text;
                });
