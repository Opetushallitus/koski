    ...
    <div className="ei-suorituksia">
      ...
      <p>
        {huollettava
          ...
          : t(
              'Mikäli huollettavasi tiedoista puuttuu opintosuorituksia tai opiskeluoikeuksia, joiden kuuluisi ylläolevien tietojen perusteella näkyä Koski-palvelussa, voit ilmoittaa asiasta oppilaitoksellesi.'
            )}
      </p>
    </div>
  )
