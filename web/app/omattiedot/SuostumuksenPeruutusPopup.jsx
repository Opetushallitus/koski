...
export const SuostumuksenPeruutusPopup = ({opiskeluoikeusOid, onDismiss}) => {
  ...
  return (<ModalDialog className='peru-suostumus-popup-modal'
      onDismiss={onDismiss}
      onSubmit={() => {
        Http.post(`/koski/api/opiskeluoikeus/suostumuksenperuutus/${opiskeluoikeusOid}`)
        .doError(() => {
        })
      ...
      validP={checkboxAtom}>
    <h2><Text name='Suostumuksen peruminen: Vapaan sivistystyön koulutus'/></h2>
    <Text name='Kun peruutat antamasi suostumuksen...'/><br/><br/>
    <Checkbox id='suostumuksen-peruutus-checkbox'
