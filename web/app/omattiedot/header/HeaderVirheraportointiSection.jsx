...
export const HeaderVirheraportointiSection = ({uiModeA, oppija}) => (
  <section className='virheraportointi' data-show={uiModeA.map(mode => mode === FormState.VIRHERAPORTOINTI)}>
    <Popup showStateAtom={uiModeA} dismissedStateValue={FormState.NONE} onFocusValue={FormState.VIRHERAPORTOINTI} inline={true} closeTitle={virheRaportointiTitle(oppija)}>
