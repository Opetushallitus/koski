...
export const HeaderHuollettavanTiedotSection = ({ uiModeA }) => (
  <section
    className="huollettavan-tiedot textstyle-body"
    data-show={uiModeA.map((mode) => mode === FormState.HUOLLETTAVANTIEDOT)}
  >
    <Popup
      showStateAtom={uiModeA}
      dismissedStateValue={FormState.NONE}
      onFocusValue={FormState.HUOLLETTAVANTIEDOT}
      inline={true}
    ...
    >
      ...
      <a
        id="valitse-huollettava"
        className="koski-button"
        onClick={valitseHuollettava}
      >
        <Text name="Tarkastele huollettavasi tietoja" />
      </a>
    </Popup>
  </section>
)
