...
export const isLukionKurssi = (m) => m && m.value.classes.includes('lukionkurssi2015')
...
export const isLukionMatematiikka = (m) => m && m.value.classes.includes('lukionmatematiikka2015')
