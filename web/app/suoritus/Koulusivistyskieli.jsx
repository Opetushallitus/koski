...
export const KoulusivistyskieliPropertyTitle = ({}) => (
  <>
    ...
    <Infobox>
      <Text className='bold' name='Koulusivistyskieli määräytyy seuraavien suoritusten perusteella'/><br/>
      <ol>
        <li>
          <Text name='Peruskoulun tai lukion päättötodistuksessa hyväksytty arvosana äidinkielenä opiskellusta suomen tai ruotsin kielestä.'/><br/>
        </li>
        <li>
