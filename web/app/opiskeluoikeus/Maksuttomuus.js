...
export const checkSuoritus = (s) => s
  ? Http.post('/koski/api/editor/check-vaatiiko-suoritus-maksuttomuus-tiedon', s)
  : Bacon.constant(false)

export const maksuttomuusOptions = [
  {
    key: 'none',
    value: t('Henkilö on syntynyt ennen vuotta 2004 ja ei ole laajennetun oppivelvollisuuden piirissä')
  },
  {
    key: true,
