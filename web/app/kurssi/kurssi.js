...
export const findKoodistoByDiaarinumero = (
  kurssiKoodistot,
  oppimaaranDiaarinumero
) => {
...
export const lisääKurssi = (
  ...
  if (kurssi) {
    ...
    const suoritusUudellaKurssilla = modelSet(
      kurssinSuoritusProto,
      kurssiWithTitle,
      'koulutusmoduuli'
    )
...
export const osasuoritusCountOk = (osasuoritukset) => {
  ...
  if (!osasuoritukset.maxItems || typeof osasuoritukset.maxItems !== 'number')
    return true // maxItems not specified
