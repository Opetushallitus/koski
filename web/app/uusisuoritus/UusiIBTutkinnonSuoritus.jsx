...
import {copyToimipiste, ibTutkinnonSuoritus, newSuoritusProto, preIBSuoritus} from '../suoritus/Suoritus'
import {modelData, modelSetValue} from '../editor/EditorModel'
import Text from '../i18n/Text'
import {oppimääränOsasuoritukset} from '../perusopetus/Perusopetus'

const suoritus = opiskeluoikeus => oppimääränOsasuoritukset(modelData(opiskeluoikeus, 'tyyppi'))
  .map(oppiaineet => modelSetValue(opiskeluoikeus, oppiaineet.value, 'osasuoritukset'))
const isIBTutkinto = opiskeluoikeus => modelData(opiskeluoikeus, 'tyyppi.koodiarvo') === 'ibtutkinto'
...
export const UusiIBTutkinnonSuoritus = {
  ...
  canAddSuoritus: (opiskeluoikeus) => isIBTutkinto(opiskeluoikeus) && !ibTutkinnonSuoritus(opiskeluoikeus),
