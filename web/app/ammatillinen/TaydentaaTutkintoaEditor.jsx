...
import {modelData, modelEmpty, modelSetData, pushModel, resetOptionalModel} from '../editor/EditorModel'
...
const TutkintoPicker = ({model}) => {
  ...
  tutkintoAtom.filter(x => !!x && !R.equals(tutkinto, x)).onValue(tut => {
    pushModel(modelSetData(model, {
      tunniste: { koodiarvo: tut.tutkintoKoodi, nimi: tut.nimi, koodistoUri: 'koulutus' },
