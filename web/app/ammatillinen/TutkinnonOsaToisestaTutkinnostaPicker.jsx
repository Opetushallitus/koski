...
const TutkinnonOsaToisestaTutkinnostaPicker = ({tutkintoAtom, tutkinnonOsaAtom, oppilaitos, autoFocus=true, tutkintoTitle = 'Tutkinto', tutkinnonOsaTitle='Tutkinnon osa', tutkintoPlaceholder=''}) =>
  (<div className="valinnat">
    <TutkintoAutocomplete autoFocus={autoFocus} tutkintoAtom={tutkintoAtom} oppilaitosP={Bacon.constant(oppilaitos)} title={<Text name={tutkintoTitle}/>} placeholder={tutkintoPlaceholder}/>
    {
