      ...
      <div className='main-content'>
        ...
        {mahdollisetRaportitP.map(raportit => (
          <div>
            ...
            {document.location.search.includes('tilastoraportit=true') && raportit && raportit.includes('perusopetuksenoppijamäärienraportti') && <PerusopetuksenOppijamäärätRaportti organisaatioAtom={organisaatioAtom}/>}
...
const PerusopetuksenOppijamäärätRaportti = ({organisaatioAtom}) => {
  const titleText = <Text name='Perusopetus-oppilasmäärät-raportti-title'/>
  const descriptionText = <Text name='Perusopetus-oppilasmäärät-raportti-description'/>
