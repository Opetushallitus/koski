...
export const UusiInternationalSchoolOppiaineDropdown = ({ model }) => {
  ...
  const suoritusProtos =
    suorituksenTyyppi(model) === 'internationalschooldiplomavuosiluokka'
      ? ['diplomatoksuoritus', 'diplomaoppiaineensuoritus'].map((c) =>
          newOsasuoritusProto(model, c)
        )
