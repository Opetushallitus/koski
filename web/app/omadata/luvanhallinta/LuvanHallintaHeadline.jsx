...
export const LuvanHallintaHeadline = ({birthday}) => (
  <div className='kayttoluvat-headline' tabIndex={0}>
    <div className='kayttoluvat-info'>
      ...
      <p className='info'>
        <Text name={'Tällä sivulla voit tarkastella ja hallinnoida antamiasi käyttölupia tietoihisi. Lisäksi näet mitkä tahot, esim. viranomaiset, ovat katsoneet opintotietojasi.'} />
      </p>
    </div>
