...
OppivelvollisilleSuunnatunVapaanSivistystyönValinnaisetSuuntautumisopinnot.className =
  'fi.oph.koski.schema.OppivelvollisilleSuunnatunVapaanSivistystyönValinnaisetSuuntautumisopinnot' as const
