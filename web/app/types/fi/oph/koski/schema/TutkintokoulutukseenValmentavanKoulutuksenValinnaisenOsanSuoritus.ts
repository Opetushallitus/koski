...
TutkintokoulutukseenValmentavanKoulutuksenValinnaisenOsanSuoritus.className =
  'fi.oph.koski.schema.TutkintokoulutukseenValmentavanKoulutuksenValinnaisenOsanSuoritus' as const
