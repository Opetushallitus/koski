...
import {
  ...
  isAikuistenPerusopetuksenOppiaineenSuoritus
} from './AikuistenPerusopetuksenOppiaineenSuoritus'
import {
...
import {
  ...
  isAmmatillisenTutkinnonOsaaPienemmänKokonaisuudenSuoritus
} from './AmmatillisenTutkinnonOsaaPienemmanKokonaisuudenSuoritus'
import {
...
import {
  ...
  isDIAOppiaineenTutkintovaiheenOsasuorituksenSuoritus
} from './DIAOppiaineenTutkintovaiheenOsasuorituksenSuoritus'
import {
  DIAOppiaineenTutkintovaiheenSuoritus,
  isDIAOppiaineenTutkintovaiheenSuoritus
} from './DIAOppiaineenTutkintovaiheenSuoritus'
import {
  DIAOppiaineenValmistavanVaiheenLukukaudenSuoritus,
  isDIAOppiaineenValmistavanVaiheenLukukaudenSuoritus
} from './DIAOppiaineenValmistavanVaiheenLukukaudenSuoritus'
import {
  DIAOppiaineenValmistavanVaiheenSuoritus,
  isDIAOppiaineenValmistavanVaiheenSuoritus
...
import {
  ...
  isEBOppiaineenAlaosasuoritus
} from './EBOppiaineenAlaosasuoritus'
import {
  EBTutkinnonOsasuoritus,
  isEBTutkinnonOsasuoritus
} from './EBTutkinnonOsasuoritus'
import {
  EBTutkinnonSuoritus,
...
import {
  ...
  isIBCoreKurssinSuoritus
} from './IBCoreKurssinSuoritus'
import { IBDPCoreSuoritus, isIBDPCoreSuoritus } from './IBDPCoreSuoritus'
import {
  IBExtendedEssaySuoritus,
  isIBExtendedEssaySuoritus
} from './IBExtendedEssaySuoritus'
import { IBKurssinSuoritus, isIBKurssinSuoritus } from './IBKurssinSuoritus'
import {
...
import {
  ...
  isIBTheoryOfKnowledgeSuoritus
} from './IBTheoryOfKnowledgeSuoritus'
import {
  IBTutkinnonSuoritus,
...
import {
  ...
  isKorkeakouluopintojenSuoritus
} from './KorkeakouluopintojenSuoritus'
import {
...
} from './LukionKurssinSuoritus2015'
import {
...
import {
  ...
  isLukioonValmistavanKoulutuksenSuoritus
} from './LukioonValmistavanKoulutuksenSuoritus'
import {
  LukioonValmistavanKurssinSuoritus,
  isLukioonValmistavanKurssinSuoritus
} from './LukioonValmistavanKurssinSuoritus'
import {
  MYPOppiaineenSuoritus,
  isMYPOppiaineenSuoritus
} from './MYPOppiaineenSuoritus'
import {
...
import {
  ...
  isNäyttötutkintoonValmistavanKoulutuksenOsanSuoritus
} from './NayttotutkintoonValmistavanKoulutuksenOsanSuoritus'
import {
...
import {
  ...
  isPYPOppiaineenSuoritus
} from './PYPOppiaineenSuoritus'
import {
...
import {
  ...
  isPerusopetukseenValmistavanOpetuksenSuoritus
} from './PerusopetukseenValmistavanOpetuksenSuoritus'
import {
...
import {
  ...
  isPerusopetuksenLisäopetuksenSuoritus
} from './PerusopetuksenLisaopetuksenSuoritus'
import {
...
import {
  ...
  isPreIBKurssinSuoritus2015
} from './PreIBKurssinSuoritus2015'
import {
...
import {
  ...
  isPrimaryLapsiOppimisalueenAlaosasuoritus
} from './PrimaryLapsiOppimisalueenAlaosasuoritus'
import {
...
import {
  ...
  isPrimaryOppimisalueenAlaosasuoritus
} from './PrimaryOppimisalueenAlaosasuoritus'
import {
...
import {
  ...
  isS7OppiaineenAlaosasuoritus
} from './S7OppiaineenAlaosasuoritus'
import {
  SecondaryLowerOppiaineenSuoritus,
  isSecondaryLowerOppiaineenSuoritus
} from './SecondaryLowerOppiaineenSuoritus'
import {
...
import {
  ...
  isTaiteenPerusopetuksenPaikallisenOpintokokonaisuudenSuoritus
} from './TaiteenPerusopetuksenPaikallisenOpintokokonaisuudenSuoritus'
import {
...
import {
  ...
  isTelmaKoulutuksenOsanSuoritus
} from './TelmaKoulutuksenOsanSuoritus'
import {
...
} from './TutkintokoulutukseenValmentavanKoulutuksenValinnaisenKoulutusosanOsasuorituksenSuoritus'
import {
...
import {
  ...
  isVSTKotoutumiskoulutuksenKieliJaViestintäosaamisenOsasuoritus
} from './VSTKotoutumiskoulutuksenKieliJaViestintaosaamisenOsasuoritus'
import {
...
} from './VSTKotoutumiskoulutusValinnaistenOpintojenAlaosasuoritus'
import {
...
} from './VapaanSivistystyonLukutaitokoulutuksenKokonaisuudenSuoritus'
import {
...
} from './VapaanSivistystyonMaahanmuuttajienKotoutumiskoulutuksenValinnaistenOpintojenOsasuoritus'
import {
...
} from './YlioppilastutkinnonKokeenSuoritus'
import {
 ...
 * Suoritus
 *
 * @see `fi.oph.koski.schema.Suoritus`
 */
...
export const isSuoritus = (a: any): a is Suoritus =>
  ...
  isIBCASSuoritus(a) ||
  isIBCoreKurssinSuoritus(a) ||
  isIBDPCoreSuoritus(a) ||
