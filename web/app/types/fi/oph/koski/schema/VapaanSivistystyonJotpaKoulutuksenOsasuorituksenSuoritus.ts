...
VapaanSivistystyönJotpaKoulutuksenOsasuorituksenSuoritus.className =
  'fi.oph.koski.schema.VapaanSivistystyönJotpaKoulutuksenOsasuorituksenSuoritus' as const
