...
import {
  ...
  isAmmatillisenTutkinnonOsaaPienempiKokonaisuus
} from './AmmatillisenTutkinnonOsaaPienempiKokonaisuus'
import {
  KorkeakouluopintojenTutkinnonOsaaPienempiKokonaisuus,
  isKorkeakouluopintojenTutkinnonOsaaPienempiKokonaisuus
} from './KorkeakouluopintojenTutkinnonOsaaPienempiKokonaisuus'
import {
...
import {
  ...
  isMuuPerusopetuksenLisäopetuksenKoulutusmoduuli
} from './MuuPerusopetuksenLisaopetuksenKoulutusmoduuli'
import {
  MuunAmmatillisenKoulutuksenOsasuoritus,
  isMuunAmmatillisenKoulutuksenOsasuoritus
} from './MuunAmmatillisenKoulutuksenOsasuoritus'
import {
...
import {
  ...
  isPaikallinenLukionOpinto
} from './PaikallinenLukionOpinto'
import {
...
import {
  ...
  isPaikallinenOpintovalmiuksiaTukevaOpinto
} from './PaikallinenOpintovalmiuksiaTukevaOpinto'
import {
...
import {
  ...
  isTutkinnonOsaaPienemmistäKokonaisuuksistaKoostuvaKoulutus
} from './TutkinnonOsaaPienemmistaKokonaisuuksistaKoostuvaKoulutus'
import {
  TutkinnonOsaaPienempiKokonaisuus,
  isTutkinnonOsaaPienempiKokonaisuus
} from './TutkinnonOsaaPienempiKokonaisuus'
import {
...
export const isPaikallinenKoulutusmoduuli = (
  ...
  isKorkeakouluopintojenTutkinnonOsaaPienempiKokonaisuus(a) ||
  isLukionPaikallinenOpintojakso2019(a) ||
  isMuuPerusopetuksenLisäopetuksenKoulutusmoduuli(a) ||
  isMuunAmmatillisenKoulutuksenOsasuoritus(a) ||
  ...
  isPaikallinenOpintovalmiuksiaTukevaOpinto(a) ||
  ...
  isTutkinnonOsaaPienemmistäKokonaisuuksistaKoostuvaKoulutus(a) ||
  isTutkinnonOsaaPienempiKokonaisuus(a) ||
  isVSTKotoutumiskoulutuksenValinnaistenOpintojenAlasuorituksenKoulutusmoduuli2022(
    a
  ) ||
