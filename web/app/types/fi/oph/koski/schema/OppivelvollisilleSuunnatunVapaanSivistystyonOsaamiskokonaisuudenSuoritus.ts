...
OppivelvollisilleSuunnatunVapaanSivistystyönOsaamiskokonaisuudenSuoritus.className =
  'fi.oph.koski.schema.OppivelvollisilleSuunnatunVapaanSivistystyönOsaamiskokonaisuudenSuoritus' as const
