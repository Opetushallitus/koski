...
TutkintokoulutukseenValmentavaKoulutuksenMuunOsanSuoritus.className =
  'fi.oph.koski.schema.TutkintokoulutukseenValmentavaKoulutuksenMuunOsanSuoritus' as const
