...
TutkintokoulutukseenValmentavatAmmatillisenKoulutuksenOpinnot.className =
  'fi.oph.koski.schema.TutkintokoulutukseenValmentavatAmmatillisenKoulutuksenOpinnot' as const
