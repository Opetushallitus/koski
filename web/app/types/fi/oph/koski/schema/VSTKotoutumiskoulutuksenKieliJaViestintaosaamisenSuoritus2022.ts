...
VSTKotoutumiskoulutuksenKieliJaViestintäosaamisenSuoritus2022.className =
  'fi.oph.koski.schema.VSTKotoutumiskoulutuksenKieliJaViestintäosaamisenSuoritus2022' as const
