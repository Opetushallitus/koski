...
OsittaisenAmmatillisenTutkinnonOsanKorkeakouluopintoSuoritus.className =
  'fi.oph.koski.schema.OsittaisenAmmatillisenTutkinnonOsanKorkeakouluopintoSuoritus' as const
