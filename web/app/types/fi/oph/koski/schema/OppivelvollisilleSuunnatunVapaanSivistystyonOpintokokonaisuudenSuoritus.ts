...
OppivelvollisilleSuunnatunVapaanSivistystyönOpintokokonaisuudenSuoritus.className =
  'fi.oph.koski.schema.OppivelvollisilleSuunnatunVapaanSivistystyönOpintokokonaisuudenSuoritus' as const
