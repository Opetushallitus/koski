...
TutkinnonOsaaPienemmistäKokonaisuuksistaKoostuvaKoulutus.className =
  'fi.oph.koski.schema.TutkinnonOsaaPienemmistäKokonaisuuksistaKoostuvaKoulutus' as const
