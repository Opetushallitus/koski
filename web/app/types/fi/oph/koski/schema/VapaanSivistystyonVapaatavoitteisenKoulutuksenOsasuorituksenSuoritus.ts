...
VapaanSivistystyönVapaatavoitteisenKoulutuksenOsasuorituksenSuoritus.className =
  'fi.oph.koski.schema.VapaanSivistystyönVapaatavoitteisenKoulutuksenOsasuorituksenSuoritus' as const
