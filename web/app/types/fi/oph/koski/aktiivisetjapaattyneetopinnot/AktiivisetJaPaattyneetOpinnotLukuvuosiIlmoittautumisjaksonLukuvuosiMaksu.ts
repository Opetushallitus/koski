 ...
 *
 * @see `fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotLukuvuosi_IlmoittautumisjaksonLukuvuosiMaksu`
 */
export type AktiivisetJaPäättyneetOpinnotLukuvuosi_IlmoittautumisjaksonLukuvuosiMaksu =
  {
    $class: 'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotLukuvuosi_IlmoittautumisjaksonLukuvuosiMaksu'
    maksettu?: boolean
    summa?: number
    apuraha?: number
  }
...
export const AktiivisetJaPäättyneetOpinnotLukuvuosi_IlmoittautumisjaksonLukuvuosiMaksu =
  (
    ...
    $class:
      'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotLukuvuosi_IlmoittautumisjaksonLukuvuosiMaksu',
    ...o
  })

AktiivisetJaPäättyneetOpinnotLukuvuosi_IlmoittautumisjaksonLukuvuosiMaksu.className =
  'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotLukuvuosi_IlmoittautumisjaksonLukuvuosiMaksu' as const
