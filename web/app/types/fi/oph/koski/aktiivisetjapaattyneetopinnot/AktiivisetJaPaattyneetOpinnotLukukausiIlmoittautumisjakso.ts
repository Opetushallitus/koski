 ...
 *
 * @see `fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautumisjakso`
 */
export type AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautumisjakso = {
  $class: 'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautumisjakso'
...
export const AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautumisjakso = (o: {
  ...
  $class:
    'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautumisjakso',
  ...o
})

AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautumisjakso.className =
  'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautumisjakso' as const
