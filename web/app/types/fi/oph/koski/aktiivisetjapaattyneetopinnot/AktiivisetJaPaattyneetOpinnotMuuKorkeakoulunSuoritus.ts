 ...
 *
 * @see `fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotMuuKorkeakoulunSuoritus`
 */
export type AktiivisetJaPäättyneetOpinnotMuuKorkeakoulunSuoritus = {
  $class: 'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotMuuKorkeakoulunSuoritus'
...
export const AktiivisetJaPäättyneetOpinnotMuuKorkeakoulunSuoritus = (o: {
  ...
  $class:
    'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotMuuKorkeakoulunSuoritus',
  ...o
})

AktiivisetJaPäättyneetOpinnotMuuKorkeakoulunSuoritus.className =
  'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotMuuKorkeakoulunSuoritus' as const
