 ...
 *
 * @see `fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotMuunAmmatillisenKoulutuksenSuoritus`
 */
export type AktiivisetJaPäättyneetOpinnotMuunAmmatillisenKoulutuksenSuoritus = {
  $class: 'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotMuunAmmatillisenKoulutuksenSuoritus'
...
export const AktiivisetJaPäättyneetOpinnotMuunAmmatillisenKoulutuksenSuoritus =
  (o: {
    ...
    $class:
      'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotMuunAmmatillisenKoulutuksenSuoritus',
    ...o
  })

AktiivisetJaPäättyneetOpinnotMuunAmmatillisenKoulutuksenSuoritus.className =
  'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotMuunAmmatillisenKoulutuksenSuoritus' as const
