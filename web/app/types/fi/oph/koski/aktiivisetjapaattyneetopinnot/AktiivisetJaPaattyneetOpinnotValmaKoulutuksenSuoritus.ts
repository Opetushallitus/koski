 ...
 *
 * @see `fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotValmaKoulutuksenSuoritus`
 */
export type AktiivisetJaPäättyneetOpinnotValmaKoulutuksenSuoritus = {
  $class: 'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotValmaKoulutuksenSuoritus'
...
export const AktiivisetJaPäättyneetOpinnotValmaKoulutuksenSuoritus = (o: {
  ...
  $class:
    'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotValmaKoulutuksenSuoritus',
  ...o
})

AktiivisetJaPäättyneetOpinnotValmaKoulutuksenSuoritus.className =
  'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotValmaKoulutuksenSuoritus' as const
