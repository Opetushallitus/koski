 ...
 *
 * @see `fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotPäätasonSuoritus`
 */
export type AktiivisetJaPäättyneetOpinnotPäätasonSuoritus = {
  $class: 'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotPäätasonSuoritus'
...
export const AktiivisetJaPäättyneetOpinnotPäätasonSuoritus = (o: {
  ...
  $class:
    'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotPäätasonSuoritus',
  ...o
})

AktiivisetJaPäättyneetOpinnotPäätasonSuoritus.className =
  'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotPäätasonSuoritus' as const
