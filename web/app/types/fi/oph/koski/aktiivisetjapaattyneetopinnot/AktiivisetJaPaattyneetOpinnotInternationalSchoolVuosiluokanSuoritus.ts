 ...
 *
 * @see `fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotInternationalSchoolVuosiluokanSuoritus`
 */
export type AktiivisetJaPäättyneetOpinnotInternationalSchoolVuosiluokanSuoritus =
  {
    $class: 'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotInternationalSchoolVuosiluokanSuoritus'
...
export const AktiivisetJaPäättyneetOpinnotInternationalSchoolVuosiluokanSuoritus =
  (o: {
    ...
    $class:
      'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotInternationalSchoolVuosiluokanSuoritus',
    ...o
  })

AktiivisetJaPäättyneetOpinnotInternationalSchoolVuosiluokanSuoritus.className =
  'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotInternationalSchoolVuosiluokanSuoritus' as const
