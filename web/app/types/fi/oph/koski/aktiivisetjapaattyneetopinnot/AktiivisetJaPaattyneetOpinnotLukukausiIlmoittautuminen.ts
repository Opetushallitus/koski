 ...
 *
 * @see `fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautuminen`
 */
export type AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautuminen = {
  $class: 'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautuminen'
...
export const AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautuminen = (
  ...
  $class:
    'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautuminen',
  ilmoittautumisjaksot: [],
  ...o
})

AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautuminen.className =
  'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotLukukausi_Ilmoittautuminen' as const
