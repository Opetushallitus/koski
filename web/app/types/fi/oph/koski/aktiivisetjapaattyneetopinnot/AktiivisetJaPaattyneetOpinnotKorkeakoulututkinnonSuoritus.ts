 ...
 *
 * @see `fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotKorkeakoulututkinnonSuoritus`
 */
export type AktiivisetJaPäättyneetOpinnotKorkeakoulututkinnonSuoritus = {
  $class: 'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotKorkeakoulututkinnonSuoritus'
...
export const AktiivisetJaPäättyneetOpinnotKorkeakoulututkinnonSuoritus = (o: {
  ...
  $class:
    'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotKorkeakoulututkinnonSuoritus',
  ...o
})

AktiivisetJaPäättyneetOpinnotKorkeakoulututkinnonSuoritus.className =
  'fi.oph.koski.aktiivisetjapaattyneetopinnot.AktiivisetJaPäättyneetOpinnotKorkeakoulututkinnonSuoritus' as const
