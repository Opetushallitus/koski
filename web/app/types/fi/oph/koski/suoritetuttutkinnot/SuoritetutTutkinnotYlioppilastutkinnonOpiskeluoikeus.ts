 ...
 *
 * @see `fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotYlioppilastutkinnonOpiskeluoikeus`
 */
export type SuoritetutTutkinnotYlioppilastutkinnonOpiskeluoikeus = {
  $class: 'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotYlioppilastutkinnonOpiskeluoikeus'
...
export const SuoritetutTutkinnotYlioppilastutkinnonOpiskeluoikeus = (
  ...
  suoritukset: [],
  $class:
    'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotYlioppilastutkinnonOpiskeluoikeus',
  ...o
})

SuoritetutTutkinnotYlioppilastutkinnonOpiskeluoikeus.className =
  'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotYlioppilastutkinnonOpiskeluoikeus' as const
