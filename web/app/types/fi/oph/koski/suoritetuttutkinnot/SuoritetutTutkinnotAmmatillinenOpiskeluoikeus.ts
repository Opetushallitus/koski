 ...
 *
 * @see `fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotAmmatillinenOpiskeluoikeus`
 */
export type SuoritetutTutkinnotAmmatillinenOpiskeluoikeus = {
  $class: 'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotAmmatillinenOpiskeluoikeus'
...
export const SuoritetutTutkinnotAmmatillinenOpiskeluoikeus = (
  ...
  suoritukset: [],
  $class:
    'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotAmmatillinenOpiskeluoikeus',
  ...o
})

SuoritetutTutkinnotAmmatillinenOpiskeluoikeus.className =
  'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotAmmatillinenOpiskeluoikeus' as const
