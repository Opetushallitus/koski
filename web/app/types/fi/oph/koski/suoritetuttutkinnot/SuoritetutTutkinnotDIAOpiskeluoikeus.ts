 ...
 *
 * @see `fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotDIAOpiskeluoikeus`
 */
export type SuoritetutTutkinnotDIAOpiskeluoikeus = {
  $class: 'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotDIAOpiskeluoikeus'
...
export const SuoritetutTutkinnotDIAOpiskeluoikeus = (
  ...
  suoritukset: [],
  $class:
    'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotDIAOpiskeluoikeus',
  ...o
})

SuoritetutTutkinnotDIAOpiskeluoikeus.className =
  'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotDIAOpiskeluoikeus' as const
