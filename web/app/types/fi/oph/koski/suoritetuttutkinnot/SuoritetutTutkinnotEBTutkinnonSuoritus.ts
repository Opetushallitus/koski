 ...
 *
 * @see `fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotEBTutkinnonSuoritus`
 */
export type SuoritetutTutkinnotEBTutkinnonSuoritus = {
  $class: 'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotEBTutkinnonSuoritus'
...
export const SuoritetutTutkinnotEBTutkinnonSuoritus = (o: {
  ...
  $class:
    'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotEBTutkinnonSuoritus',
  ...o
})

SuoritetutTutkinnotEBTutkinnonSuoritus.className =
  'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotEBTutkinnonSuoritus' as const
