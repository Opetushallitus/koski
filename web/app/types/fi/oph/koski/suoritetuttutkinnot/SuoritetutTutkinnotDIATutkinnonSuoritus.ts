 ...
 *
 * @see `fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotDIATutkinnonSuoritus`
 */
export type SuoritetutTutkinnotDIATutkinnonSuoritus = {
  $class: 'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotDIATutkinnonSuoritus'
...
export const SuoritetutTutkinnotDIATutkinnonSuoritus = (o: {
  ...
  $class:
    'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotDIATutkinnonSuoritus',
  ...o
})

SuoritetutTutkinnotDIATutkinnonSuoritus.className =
  'fi.oph.koski.suoritetuttutkinnot.SuoritetutTutkinnotDIATutkinnonSuoritus' as const
