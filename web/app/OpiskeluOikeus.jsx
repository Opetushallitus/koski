      ...
      <div className="opiskeluoikeus">
        {
          opiskeluOikeus.suoritukset
            .filter((suoritus) => /perusopetuksenoppimaara|perusopetuksenoppiaineenoppimaara|lukionoppimaara|ammatillinentutkinto|korkeakoulututkinto/.test(suoritus.tyyppi.koodiarvo))
            .map((suoritus, index) =>  {
