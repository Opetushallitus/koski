...
export const OpiskeluOikeus = React.createClass({
  ...
  render() {
    let {opiskeluOikeus, oppija, lens} = this.props
      ...
      <div className="opiskeluoikeus">
        {
          opiskeluOikeus.suoritukset
            .filter((suoritus) => /perusopetuksenoppimaara|perusopetuksenoppiaineenoppimaara|perusopetuksenlisaopetus|perusopetuksenvuosiluokka|lukionoppimaara|luva|ammatillinentutkinto|korkeakoulututkinto|ylioppilastutkinto/.test(suoritus.tyyppi.koodiarvo))
            .map((suoritus, index) =>  {
...
const Todistus = React.createClass({
  render() {
    ...
    let href = '/koski/todistus/' + oppija.oid + '?opiskeluoikeusTyyppi=' + opiskeluOikeus.tyyppi.koodiarvo + '&koulutusmoduuli=' + suoritus.koulutusmoduuli.tunniste.koodistoUri + "/" + suoritus.koulutusmoduuli.tunniste.koodiarvo
...
const OpiskeluoikeudenOpintosuoritusote = React.createClass({
  render() {
    ...
    if (opiskeluoikeus.tyyppi.koodiarvo == 'lukiokoulutus') { // vain lukiokoulutukselle näytetään opiskeluoikeuskohtainen suoritusote
      let href = '/koski/opintosuoritusote/' + oppija.oid + '?opiskeluoikeus=' + opiskeluoikeus.id
