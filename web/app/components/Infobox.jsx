...
export const Infobox = ({children}) => {
  ...
  return (
    <span className='infobox'>
      ...
      {
        ift(showInfo.map(R.identity), <InfoText children={children} onClick={() => showInfo.set(false)}/>)
      }
    </span>
  )
}
...
const InfoText = ({onClick, children}) => (
  <>
    ...
    <span className='info-content'>
      <button className='info-content-close' onClick={onClick} aria-label={t('Sulje')}/>
      {children}
    </span>
  </>
)
