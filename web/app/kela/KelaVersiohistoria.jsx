  ...
  return (
    <div className="versiohistoria">
      {historyObs.combine(showHistoryAtom, (history, showHistory) => {
        return (
          <>
            <span onClick={() => showHistoryAtom.set(!showHistory)}>
            ...
            {showHistory && (
              <div className="kela-modal">
                <div className="kela-modal-content">
                  <button
                    onClick={() => showHistoryAtom.set(false)}
                    className="kela-content-close"
                  />
                  <ol>
                    {history.map((version, i) => (
                      <li
                        key={i}
                        className={
                          versionumero === version.versionumero
                            ? 'selected'
                            : ''
                        }
                      >
                        <Link
                          href={`/koski/kela/versiohistoria/${oppijaOid}/${opiskeluoikeudenOid}/${version.versionumero}`}
                        >
