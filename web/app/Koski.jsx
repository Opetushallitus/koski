...
import {contentP, titleP} from './router.jsx'
import {TopBar} from './TopBar.jsx'
import {locationP} from './location.js'
import {saveBus} from './Oppija.jsx'


// Stays at `true` for five seconds after latest saved change. Reset to `false` when another Oppija is selected.
const savedP = saveBus.flatMapLatest(() => Bacon.once(true).concat((locationP.changes().merge(Bacon.later(5000))).map(false))).toProperty(false).skipDuplicates()
