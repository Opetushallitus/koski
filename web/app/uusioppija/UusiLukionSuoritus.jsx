...
export default ({suoritusAtom, oppilaitosAtom, suorituskieliAtom}) => {
  ...
  const suoritustyypitP = koodistoValues('suorituksentyyppi/lukionoppimaara,lukionoppiaineenoppimaara,lukionaineopinnot')
  ...
  Bacon.combineWith(
    oppilaitosAtom, suoritustyyppiAtom, perusteAtom, suorituskieliAtom, oppiaineenSuoritusAtom,
    makeSuoritus
  ...
  return (
    <span>
      ...
      {
        suoritustyyppiAtom.map(tyyppi => koodiarvoMatch('lukionoppiaineenoppimaara')(tyyppi)
