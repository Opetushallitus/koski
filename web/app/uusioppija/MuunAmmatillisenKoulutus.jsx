...
export default ({
  ...
  const ammatilliseentehtavaanvalmistavakoulutusP = koodistoValues(
  ...
  return (
    <div className="koulutusmoduuli">
      ...
      {ift(
        koulutusmoduulityyppiAtom.map(
          (k) => k === ammatilliseenTehtäväänValmistavaKoulutus
        ),
        <KoodistoDropdown
      ...
      {ift(
        koulutusmoduulityyppiAtom.map((k) => k === paikallinenKoulutus),
...
const ammatilliseenTehtäväänValmistavaKoulutus =
