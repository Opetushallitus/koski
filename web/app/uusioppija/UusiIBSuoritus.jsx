...
export default ({suoritusAtom, oppilaitosAtom, suorituskieliAtom}) => {
  ...
  const suoritustyypitP = koodistoValues('suorituksentyyppi/ibtutkinto,preiboppimaara')
  suoritustyypitP.onValue(tyypit => suoritustyyppiAtom.set(tyypit.find(koodiarvoMatch('ibtutkinto'))))
