    ...
    describe('Opiskeluoikeuden lisääminen', function () {
      describe('Paikallinen koulutusmoduuli', function () {
        ...
        it('Lisätty opiskeluoikeus näytetään', function () {
          expect(
            opinnot.opiskeluoikeudet.valitunVälilehdenAlaotsikot()[0]
          ).to.match(/^Muun ammatillisen koulutuksen suoritus*/)
          expect(opinnot.getKoulutusModuuli().nimi).to.equal(
            'Varaston täyttäminen'
          )
          expect(opinnot.getKoulutusModuuli().koodi).to.equal('vrs-t-2019-k')
          expect(opinnot.getKoulutusModuuli().kuvaus).to.equal(
      ...
      describe('Ammatilliseen tehtävään valmistava koulutus', function () {
        before(
          prepareForNewOppija('kalle', '230872-7258'),
          addOppija.enterValidDataMuuAmmatillinen({
            koulutusmoduuli: 'Ammatilliseen tehtävään valmistava koulutus'
          }),
    ...
    describe('Tietojen muuttaminen', function () {
      ...
      describe('Osasuorituksen osasuorituksen lisääminen', function () {
        ...
        before(
          ...
          osasuoritus
            .propertyBySelector('.laajuudenyksikko')
            .setValue('opintopistettä'),
          osasuoritus
            .osanOsat()
            .lisääPaikallinenTutkinnonOsa('Asunto-osakeyhtiolain perusteet'),
          ...
          osasuoritus
            ...
            .lisääPaikallinenTutkinnonOsa(
              'Huoneenvuokralainsäädännön perusteet'
            ),
        ...
        describe('Kun laajuudet täsmää', function () {
          ...
          describe('Osasuorituksen osasuoritukseen lisääminen', function () {
            before(editor.edit, opinnot.avaaKaikki, osanOsa1.toggleExpand)

            it('on estetty', function () {
              expect(extractAsText(osanOsa1.elem())).to.not.contain(
                'Lisää osasuoritus'
              )
            })
          })
      ...
      describe('Yhteisen tutkinnon osan osa-alueen lisääminen', function () {
        describe('Koodistosta löytyvä osan osa-alue', function () {
          ...
          it('onnistuu', function () {
            expect(opinnot.tutkinnonOsat().osienTekstit()).to.include('Etiikka')
          })
        })
          ...
          before(
            ...
            opinnot
              ...
              .lisääPaikallinenTutkinnonOsa(
                ...
                ':contains(Lisää paikallinen yhteisen tutkinnon osan osa-alue)'
              ),
            editor.saveChangesAndWaitForSuccess
          )
  ...
  describe('Tutkinnon osaa pienemmistä kokonaisuuksista koostuva suoritus', function () {
    ...
    describe('Tietojen muuttaminen', function () {
      before(
        resetFixtures,
        page.openPage,
        page.oppijaHaku.searchAndSelect('040754-054W')
      )
      ...
      describe('Tutkinnon osaa pienemmän kokonaisuuden suorituksen muuttaminen', function () {
        before(
          ...
          opinnot
            ...
            .valitseTutkinto('Autoalan perustutkinto'),
          opinnot
            .tutkinnonOsat()
            .tutkinnonOsa(0)
            .liittyyTutkinnonOsaan()
