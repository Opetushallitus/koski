    ...
    describe('nimellä', function () {
      ...
      it('Oletusjärjestys nouseva nimen mukaan', function () {
        expect(page.oppijataulukko.names()).to.deep.equal([
          ...
          'ErityinenTutkinto, NuortenPerusopetus',
          'Hetuton, Heikki',
          'Hetuton, Heikki-Lapsi',
          'k, kotiopetus',
          'Kelalle, Useita',
          'Kelalle, Useita',
          'Kelalle-Perusopetus, Uudet-Lisätiedot',
          'KolmetoistaViisitoista, Kalle',
          'Kotiopetus, Kerttu',
          'Koululainen, Kaisa',
          'Kuusi, Kaisa',
          'KuusitoistaEiErityista, Ilmari',
          'KuusitoistaErityinen, Essi',
          'Lukiolainen, Liisa',
          'Luokallejäänyt, Lasse',
          'Menehtynyt, Mette',
          'Monia, Useita',
          ...
          'Oppija, Oili',
          'Perusopetuksensiirto, Pertti',
          'SeitsemanKaksitoista, Sami',
          't, tavallinen',
          'Toiminta, Tommi',
          'Tupla, Toivo',
          'Turvakielto, Lapsi',
          'Turvakielto, Toinen-Lapsi',
