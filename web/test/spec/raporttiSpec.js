describe('Raportti', function () {
  ...
  describe('Raportin tiedot', function () {
    ...
    it('opiskeluoikeuksien määrä', function () {
      expect(page.metric('opiskeluoikeuksien-määrä').value() >= 0).to.equal(
        true
      )
    })
    ...
    it('ammatillisen opiskeluoikeuksien määrä', function () {
      expect(
        page.metric('opiskeluoikeuksien-määrä-ammatillinen-koulutus').value() >=
          0
      ).to.equal(true)
    })
    ...
    it('perusopetuksen opiskeluoikeuksien määrä', function () {
      expect(
        page.metric('opiskeluoikeuksien-määrä-perusopetus').value() >= 0
      ).to.equal(true)
    })

    it('lukion opiskeluoikeuksien määrä', function () {
      expect(
        page.metric('opiskeluoikeuksien-määrä-lukiokoulutus').value() >= 0
      ).to.equal(true)
    })

    it('ib:n opiskeluoikeuksien määrä', function () {
      expect(
        page.metric('opiskeluoikeuksien-määrä-ib-tutkinto').value() >= 0
      ).to.equal(true)
    })

    it('esiopetuksen opiskeluoikeuksien määrä', function () {
      expect(
        page.metric('opiskeluoikeuksien-määrä-esiopetus').value() >= 0
      ).to.equal(true)
    })
    ...
    it('luvan opiskeluoikeuksien määrä', function () {
      expect(
        page
          .metric('opiskeluoikeuksien-määrä-lukioon-valmistava-koulutus-luva')
          .value() >= 0
      ).to.equal(true)
    })
    ...
    it('perusopetukseen valmistavan opiskeluoikeuksien määrä', function () {
      expect(
        page
          .metric('opiskeluoikeuksien-määrä-perusopetukseen-valmistava-opetus')
          .value() >= 0
      ).to.equal(true)
    })
    ...
    it('perusopetuksen lisäopetuksen opiskeluoikeuksien määrä', function () {
      expect(
        page
          .metric('opiskeluoikeuksien-määrä-perusopetuksen-lisäopetus')
          .value() >= 0
      ).to.equal(true)
    })
    ...
    it('pääkäyttäjien määrä', function () {
      expect(
        page
          .metric(
            'käyttöoikeuksien-määrä-koski-oppilaitos-pääkäyttäjä_1494486198456'
          )
          .value() >= 0
      ).to.equal(true)
    })
    ...
    it('vastuukäyttäjien määrä', function () {
      expect(
        page.metric('käyttöoikeuksien-määrä-Vastuukayttajat').value() >= 0
      ).to.equal(true)
    })

    it('tiedonsiirtovirheiden määrä', function () {
      expect(page.metric('tiedonsiirtovirheiden-määrä').value() >= 0).to.equal(
        true
      )
    })
