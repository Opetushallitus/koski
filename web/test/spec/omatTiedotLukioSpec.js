describe('Omat tiedot - lukio', function() {
  ...
  describe('Mobiilinäkymä', function () {
    ...
    describe('Lukiosta valmistunut', function () {
      before(etusivu.login(), wait.until(korhopankki.isReady), korhopankki.login('020655-2479'), wait.until(omattiedot.isVisible))

      describe('Kun opiskeluoikeus avataan', function () {
        before(opinnot.valitseOmatTiedotOpiskeluoikeus('Lukion oppimäärä (2012—2016, valmistunut)'))
        ...
        describe('Kun oppiainetta klikataan', function () {
          before(opinnot.valitseOmatTiedotOpiskeluoikeudenLukionSuoritus('Lukion oppimäärä (2012—2016, valmistunut)', 'Äidinkieli ja kirjallisuus'))
  ...
  describe('Työpöytänäkymä', function () {
    describe('Lukiosta valmistunut', function () {
      ...
      it('Opiskeluoikeus näytetään listassa', function () {
        expect(opinnot.opiskeluoikeudet.omatTiedotOpiskeluoikeuksienOtsikot()).to.contain('Lukion oppimäärä (2012—2016, valmistunut)')
      })
    ...
    describe('IB-Predicted', function () {
      before(authentication.logout, etusivu.openPage)
      before(etusivu.login(), wait.until(korhopankki.isReady), korhopankki.login('071096-317K'), wait.until(omattiedot.isVisible))
      ...
      describe('Kun opiskeluoikeus avataan', function () {
        ...
        describe('Kun valitaan Pre-IB -välilehti', function () {
          before(opinnot.valitseSuoritus('IB-tutkinto (International Baccalaureate) (2012—2016, valmistunut)', 'Pre-IB', true))
